...
struct FRawDistribution {
	FDistributionLookupTable Table; // 0x00(0x20)
};
...
struct FFormatArgumentData {
	FString ArgumentName; // 0x00(0x10)
	enum class EFormatArgumentType ArgumentValueType; // 0x10(0x01)
	FText ArgumentValue; // 0x18(0x18)
...
struct FExpressionInput {
	...
	FName ExpressionName; // 0x04(0x08)
};
...
struct FHitResult {
	...
	FVector_NetQuantize ImpactPoint; // 0x1c(0x0c)
	FVector_NetQuantizeNormal Normal; // 0x28(0x0c)
	FVector_NetQuantizeNormal ImpactNormal; // 0x34(0x0c)
	FVector_NetQuantize TraceStart; // 0x40(0x0c)
	FVector_NetQuantize TraceEnd; // 0x4c(0x0c)
	float PenetrationDepth; // 0x58(0x04)
	int32_t Item; // 0x5c(0x04)
	TWeakObjectPtr<UPhysicalMaterial> PhysMaterial; // 0x60(0x08)
	TWeakObjectPtr<AActor> Actor; // 0x68(0x08)
	TWeakObjectPtr<UPrimitiveComponent> Component; // 0x70(0x08)
	FName BoneName; // 0x78(0x08)
	FName MyBoneName; // 0x80(0x08)
};
...
struct FSimpleMemberReference {
	UObject* MemberParent; // 0x00(0x08)
	FName MemberName; // 0x08(0x08)
	FGuid MemberGuid; // 0x10(0x10)
};
...
struct FInterpControlPoint {
	FVector PositionControlPoint; // 0x00(0x0c)
...
struct FPlatformInterfaceDelegateResult {
	...
	FPlatformInterfaceData Data; // 0x08(0x30)
};

// ScriptStruct Engine.PlatformInterfaceData
// Size: 0x30 (Inherited: 0x00)
struct FPlatformInterfaceData {
	FName DataName; // 0x00(0x08)
	...
	UObject* ObjectValue; // 0x28(0x08)
};

// ScriptStruct Engine.DebugFloatHistory
// Size: 0x20 (Inherited: 0x00)
struct FDebugFloatHistory {
	TArray<float> Samples; // 0x00(0x10)
...
struct FLatentActionInfo {
	...
	FName ExecutionFunction; // 0x08(0x08)
	UObject* CallbackTarget; // 0x10(0x08)
};
...
struct FBodyInstance {
	...
	FVector CustomDOFPlaneNormal; // 0x70(0x0c)
	FVector COMNudge; // 0x7c(0x0c)
	float MassScale; // 0x88(0x04)
	FVector InertiaTensorScale; // 0x8c(0x0c)
	FWalkableSlopeOverride WalkableSlopeOverride; // 0xa8(0x10)
	UPhysicalMaterial* PhysMaterialOverride; // 0xb8(0x08)
...
struct FCollisionResponse {
	FCollisionResponseContainer ResponseToChannels; // 0x00(0x20)
...
struct FUniqueNetIdRepl : FUniqueNetIdWrapper {
	TArray<char> ReplicationBytes; // 0x18(0x10)
};
...
struct FRepAttachment {
	AActor* AttachParent; // 0x00(0x08)
	FVector_NetQuantize100 LocationOffset; // 0x08(0x0c)
	FVector_NetQuantize100 RelativeScale3D; // 0x14(0x0c)
	FRotator RotationOffset; // 0x20(0x0c)
	FName AttachSocket; // 0x2c(0x08)
	USceneComponent* AttachComponent; // 0x38(0x08)
};
...
struct FInputScaleBiasClamp {
	...
	FInputRange InRange; // 0x04(0x08)
	FInputRange OutRange; // 0x0c(0x08)
...
struct FInputAlphaBoolBlend {
	...
	UCurveFloat* CustomCurve; // 0x10(0x08)
...
// Size: 0x30 (Inherited: 0x00)
struct FAlphaBlend {
	UCurveFloat* CustomCurve; // 0x00(0x08)
...
struct FRuntimeFloatCurve {
	FRichCurve EditorCurveData; // 0x00(0x80)
	UCurveFloat* ExternalCurve; // 0x80(0x08)
};

// ScriptStruct Engine.IndexedCurve
// Size: 0x68 (Inherited: 0x00)
struct FIndexedCurve {
	FKeyHandleMap KeyHandlesToIndices; // 0x08(0x60)
};
...
struct FInputBlendPose {
	TArray<FBranchFilter> BranchFilters; // 0x00(0x10)
};
...
struct FPoseSnapshot {
	TArray<FTransform> LocalTransforms; // 0x00(0x10)
	TArray<FName> BoneNames; // 0x10(0x10)
	FName SkeletalMeshName; // 0x20(0x08)
	FName SnapshotName; // 0x28(0x08)
...
struct FAnimNode_Root : FAnimNode_Base {
	...
	FName Name; // 0x20(0x08)
	FName Group; // 0x28(0x08)
};
...
struct FActorComponentInstanceData {
	UObject* SourceComponentTemplate; // 0x08(0x08)
	...
	TArray<char> SavedProperties; // 0x18(0x10)
	TArray<FActorComponentDuplicatedObjectData> DuplicatedObjects; // 0x28(0x10)
...
struct FSceneComponentInstanceData : FActorComponentInstanceData {
	TMap<USceneComponent*, FTransform> AttachedInstanceComponents; // 0x58(0x50)
};
...
struct FKAggregateGeom {
	TArray<FKSphereElem> SphereElems; // 0x00(0x10)
...
struct FKTaperedCapsuleElem : FKShapeElem {
	FVector Center; // 0x30(0x0c)
	FRotator Rotation; // 0x3c(0x0c)
...
struct FKConvexElem : FKShapeElem {
	TArray<FVector> VertexData; // 0x30(0x10)
	TArray<int32_t> IndexData; // 0x40(0x10)
	FBox ElemBox; // 0x50(0x1c)
	FTransform Transform; // 0x70(0x30)
};
...
struct FRootMotionMovementParams {
	...
	float BlendWeight; // 0x04(0x04)
	FTransform RootMotionTransform; // 0x10(0x30)
};
...
struct FAnimTickRecord {
	UAnimationAsset* SourceAsset; // 0x00(0x08)
};

// ScriptStruct Engine.MarkerSyncAnimPosition
// Size: 0x14 (Inherited: 0x00)
struct FMarkerSyncAnimPosition {
	FName PreviousMarkerName; // 0x00(0x08)
	FName NextMarkerName; // 0x08(0x08)
...
struct FBlendSampleData {
	...
	UAnimSequence* Animation; // 0x08(0x08)
...
struct FNamedTransform {
	FTransform Value; // 0x00(0x30)
	FName Name; // 0x30(0x08)
};

// ScriptStruct Engine.NamedColor
// Size: 0x0c (Inherited: 0x00)
struct FNamedColor {
	FColor Value; // 0x00(0x04)
	FName Name; // 0x04(0x08)
};

// ScriptStruct Engine.NamedVector
// Size: 0x14 (Inherited: 0x00)
struct FNamedVector {
	FVector Value; // 0x00(0x0c)
	FName Name; // 0x0c(0x08)
};
...
struct FAnimParentNodeAssetOverride {
	UAnimationAsset* NewAsset; // 0x00(0x08)
	FGuid ParentNodeGuid; // 0x08(0x10)
};
...
struct FAnimBlueprintFunctionData {
	TFieldPath<FStructProperty> OutputPoseNodeProperty; // 0x00(0x20)
	TArray<TFieldPath<FStructProperty>> InputPoseNodeProperties; // 0x20(0x10)
	TArray<TFieldPath<FProperty>> InputProperties; // 0x30(0x10)
};
...
struct FGraphAssetPlayerInformation {
	TArray<int32_t> PlayerNodeIndices; // 0x00(0x10)
};

// ScriptStruct Engine.CachedPoseIndices
// Size: 0x10 (Inherited: 0x00)
struct FCachedPoseIndices {
	TArray<int32_t> OrderedSavedPoseNodeIndices; // 0x00(0x10)
};
...
struct FAnimBlueprintFunction {
	FName Name; // 0x00(0x08)
	FName Group; // 0x08(0x08)
	int32_t OutputPoseNodeIndex; // 0x10(0x04)
	TArray<FName> InputPoseNames; // 0x18(0x10)
	TArray<int32_t> InputPoseNodeIndices; // 0x28(0x10)
...
// Size: 0x10 (Inherited: 0x00)
struct FAnimTrack {
	TArray<FAnimSegment> AnimSegments; // 0x00(0x10)
};

// ScriptStruct Engine.AnimSegment
// Size: 0x20 (Inherited: 0x00)
struct FAnimSegment {
	UAnimSequenceBase* AnimReference; // 0x00(0x08)
...
struct FRawCurveTracks {
	TArray<FFloatCurve> FloatCurves; // 0x00(0x10)
};

// ScriptStruct Engine.AnimCurveBase
// Size: 0x18 (Inherited: 0x00)
struct FAnimCurveBase {
	FName LastObservedName; // 0x00(0x08)
	FSmartName Name; // 0x08(0x0c)
...
// Size: 0x0c (Inherited: 0x00)
struct FSmartName {
	FName DisplayName; // 0x00(0x08)
};

// ScriptStruct Engine.FloatCurve
// Size: 0x98 (Inherited: 0x18)
struct FFloatCurve : FAnimCurveBase {
	FRichCurve FloatCurve; // 0x18(0x80)
};

// ScriptStruct Engine.TransformCurve
// Size: 0x4e0 (Inherited: 0x18)
struct FTransformCurve : FAnimCurveBase {
	FVectorCurve TranslationCurve; // 0x18(0x198)
	FVectorCurve RotationCurve; // 0x1b0(0x198)
	FVectorCurve ScaleCurve; // 0x348(0x198)
};

// ScriptStruct Engine.VectorCurve
// Size: 0x198 (Inherited: 0x18)
struct FVectorCurve : FAnimCurveBase {
	FRichCurve FloatCurves[0x3]; // 0x18(0x180)
};
...
// Size: 0x10 (Inherited: 0x00)
struct FA2Pose {
	TArray<FTransform> Bones; // 0x00(0x10)
};
...
struct FQueuedDrawDebugItem {
	...
	FVector StartLoc; // 0x04(0x0c)
	FVector EndLoc; // 0x10(0x0c)
	FVector Center; // 0x1c(0x0c)
	FRotator Rotation; // 0x28(0x0c)
	float Radius; // 0x34(0x04)
	float Size; // 0x38(0x04)
	int32_t Segments; // 0x3c(0x04)
	FColor Color; // 0x40(0x04)
	bool bPersistentLines; // 0x44(0x01)
	float LifeTime; // 0x48(0x04)
	float Thickness; // 0x4c(0x04)
	FString Message; // 0x50(0x10)
	FVector2D TextScale; // 0x60(0x08)
};

// ScriptStruct Engine.AnimLinkableElement
// Size: 0x30 (Inherited: 0x00)
struct FAnimLinkableElement {
	UAnimMontage* LinkedMontage; // 0x08(0x08)
	...
	UAnimSequenceBase* LinkedSequence; // 0x28(0x08)
};
...
struct FAnimMontageInstance {
	...
	TArray<int32_t> NextSections; // 0xe8(0x10)
	TArray<int32_t> PrevSections; // 0xf8(0x10)
	TArray<FAnimNotifyEvent> ActiveStateBranchingPoints; // 0x118(0x10)
	float Position; // 0x128(0x04)
	float PlayRate; // 0x12c(0x04)
	FAlphaBlend Blend; // 0x130(0x30)
...
struct FAnimNotifyEvent : FAnimLinkableElement {
	...
	FName NotifyName; // 0x40(0x08)
	UAnimNotify* Notify; // 0x48(0x08)
	UAnimNotifyState* NotifyStateClass; // 0x50(0x08)
	float Duration; // 0x58(0x04)
	FAnimLinkableElement EndLink; // 0x60(0x30)
...
struct FSlotAnimationTrack {
	FName SlotName; // 0x00(0x08)
	FAnimTrack AnimTrack; // 0x08(0x10)
};

// ScriptStruct Engine.CompositeSection
// Size: 0x58 (Inherited: 0x30)
struct FCompositeSection : FAnimLinkableElement {
	FName SectionName; // 0x30(0x08)
	float StartTime; // 0x38(0x04)
	FName NextSectionName; // 0x3c(0x08)
	TArray<UAnimMetaData*> MetaData; // 0x48(0x10)
};
...
struct FAnimNode_ApplyMeshSpaceAdditive : FAnimNode_Base {
	...
	FInputScaleBias AlphaScaleBias; // 0x90(0x08)
	FInputScaleBiasClamp AlphaScaleBiasClamp; // 0x98(0x30)
...
struct FAnimNode_CustomProperty : FAnimNode_Base {
	...
	UObject* TargetInstance; // 0x30(0x08)
};
...
struct FAnimNode_LinkedAnimGraph : FAnimNode_CustomProperty {
	...
	UAnimInstance* InstanceClass; // 0x78(0x08)
	FName Tag; // 0x80(0x08)
...
struct FAnimNode_LinkedAnimLayer : FAnimNode_LinkedAnimGraph {
	UAnimLayerInterface* Interface; // 0xa0(0x08)
	FName Layer; // 0xa8(0x08)
};
...
struct FAnimNode_LinkedInputPose : FAnimNode_Base {
	...
	FName Graph; // 0x18(0x08)
	FPoseLink InputPose; // 0x20(0x10)
};
...
struct FAnimNode_SequencePlayer : FAnimNode_AssetPlayerBase {
	...
	FInputScaleBiasClamp PlayRateScaleBiasClamp; // 0x40(0x30)
...
struct FAnimationActiveTransitionEntry {
	UBlendProfile* BlendProfile; // 0xb8(0x08)
};
...
struct FExposedValueHandler {
	FName BoundFunction; // 0x00(0x08)
	TArray<FExposedValueCopyRecord> CopyRecords; // 0x08(0x10)
	UFunction* Function; // 0x18(0x08)
	TFieldPath<FStructProperty> ValueHandlerNodeProperty; // 0x20(0x20)
};

// ScriptStruct Engine.ExposedValueCopyRecord
// Size: 0x80 (Inherited: 0x00)
struct FExposedValueCopyRecord {
	FName SourcePropertyName; // 0x00(0x08)
	FName SourceSubPropertyName; // 0x08(0x08)
	...
	TFieldPath<FProperty> DestProperty; // 0x18(0x20)
	int32_t DestArrayIndex; // 0x38(0x04)
	int32_t Size; // 0x3c(0x04)
	TFieldPath<FProperty> CachedSourceProperty; // 0x40(0x20)
	TFieldPath<FProperty> CachedSourceStructSubProperty; // 0x60(0x20)
};
...
struct FAnimNotifyArray {
	TArray<FAnimNotifyEventReference> Notifies; // 0x00(0x10)
};

// ScriptStruct Engine.AnimNotifyEventReference
// Size: 0x10 (Inherited: 0x00)
struct FAnimNotifyEventReference {
	UObject* NotifySource; // 0x08(0x08)
};

// ScriptStruct Engine.CompressedTrack
// Size: 0x38 (Inherited: 0x00)
struct FCompressedTrack {
	TArray<char> ByteStream; // 0x00(0x10)
...
struct FCurveTrack {
	...
	TArray<float> CurveWeights; // 0x08(0x10)
};

// ScriptStruct Engine.ScaleTrack
// Size: 0x20 (Inherited: 0x00)
struct FScaleTrack {
	TArray<FVector> ScaleKeys; // 0x00(0x10)
	TArray<float> Times; // 0x10(0x10)
};
...
struct FRotationTrack {
	TArray<FQuat> RotKeys; // 0x00(0x10)
	TArray<float> Times; // 0x10(0x10)
};
...
struct FTranslationTrack {
	TArray<FVector> PosKeys; // 0x00(0x10)
	TArray<float> Times; // 0x10(0x10)
};
...
struct FAnimSequenceTrackContainer {
	TArray<FRawAnimSequenceTrack> AnimationTracks; // 0x00(0x10)
...
struct FRawAnimSequenceTrack {
	TArray<FVector> PosKeys; // 0x00(0x10)
	TArray<FQuat> RotKeys; // 0x10(0x10)
	TArray<FVector> ScaleKeys; // 0x20(0x10)
};

// ScriptStruct Engine.AnimSetMeshLinkup
// Size: 0x10 (Inherited: 0x00)
struct FAnimSetMeshLinkup {
	TArray<int32_t> BoneToTrackTable; // 0x00(0x10)
};
...
struct FBakedAnimationStateMachine {
	FName MachineName; // 0x00(0x08)
	int32_t InitialState; // 0x08(0x04)
	TArray<FBakedAnimationState> States; // 0x10(0x10)
	TArray<FAnimationTransitionBetweenStates> Transitions; // 0x20(0x10)
};

// ScriptStruct Engine.AnimationStateBase
// Size: 0x08 (Inherited: 0x00)
struct FAnimationStateBase {
	FName StateName; // 0x00(0x08)
};
...
struct FAnimationTransitionBetweenStates : FAnimationStateBase {
	...
	UCurveFloat* CustomCurve; // 0x28(0x08)
	UBlendProfile* BlendProfile; // 0x30(0x08)
...
struct FBakedAnimationState {
	FName StateName; // 0x00(0x08)
	TArray<FBakedStateExitTransition> Transitions; // 0x08(0x10)
...
struct FBakedStateExitTransition {
	...
	TArray<int32_t> PoseEvaluatorLinks; // 0x10(0x10)
};

// ScriptStruct Engine.AnimationState
// Size: 0x28 (Inherited: 0x08)
struct FAnimationState : FAnimationStateBase {
	TArray<FAnimationTransitionRule> Transitions; // 0x08(0x10)
	int32_t StateRootNodeIndex; // 0x18(0x04)
	int32_t StartNotify; // 0x1c(0x04)
	int32_t EndNotify; // 0x20(0x04)
	int32_t FullyBlendedNotify; // 0x24(0x04)
...
struct FMarkerSyncData {
	TArray<FAnimSyncMarker> AuthoredSyncMarkers; // 0x00(0x10)
};

// ScriptStruct Engine.AnimSyncMarker
// Size: 0x0c (Inherited: 0x00)
struct FAnimSyncMarker {
	FName MarkerName; // 0x00(0x08)
	float Time; // 0x08(0x04)
};
...
struct FAnimNotifyTrack {
	...
	FLinearColor TrackColor; // 0x08(0x10)
};

// ScriptStruct Engine.PerBoneBlendWeights
// Size: 0x10 (Inherited: 0x00)
struct FPerBoneBlendWeights {
	TArray<FPerBoneBlendWeight> BoneBlendWeights; // 0x00(0x10)
};
...
struct FPrimaryAssetRulesCustomOverride {
	...
	FDirectoryPath FilterDirectory; // 0x08(0x10)
	FString FilterString; // 0x18(0x10)
	FPrimaryAssetRules Rules; // 0x28(0x0c)
};
...
struct FPrimaryAssetRulesOverride {
	FPrimaryAssetId PrimaryAssetId; // 0x00(0x10)
	FPrimaryAssetRules Rules; // 0x10(0x0c)
};

// ScriptStruct Engine.AssetManagerRedirect
// Size: 0x20 (Inherited: 0x00)
struct FAssetManagerRedirect {
	FString Old; // 0x00(0x10)
...
struct FPrimaryAssetTypeInfo {
	FName PrimaryAssetType; // 0x00(0x08)
	TSoftClassPtr<UObject> AssetBaseClass; // 0x08(0x28)
	UObject* AssetBaseClassLoaded; // 0x30(0x08)
	bool bHasBlueprintClasses; // 0x38(0x01)
	bool bIsEditorOnly; // 0x39(0x01)
	TArray<FDirectoryPath> Directories; // 0x40(0x10)
	TArray<FSoftObjectPath> SpecificAssets; // 0x50(0x10)
	FPrimaryAssetRules Rules; // 0x60(0x0c)
	TArray<FString> AssetScanPaths; // 0x70(0x10)
...
struct FAssetMapping {
	UAnimationAsset* SourceAsset; // 0x00(0x08)
	UAnimationAsset* TargetAsset; // 0x08(0x08)
};
...
struct FBaseAttenuationSettings {
	...
	FVector AttenuationShapeExtents; // 0x14(0x0c)
	float ConeOffset; // 0x20(0x04)
	float FalloffDistance; // 0x24(0x04)
	FRuntimeFloatCurve CustomAttenuationCurve; // 0x28(0x88)
};
...
struct FAudioComponentParam {
	...
	USoundWave* SoundWaveParam; // 0x18(0x08)
};
...
struct FLaunchOnTestSettings {
	FFilePath LaunchOnTestmap; // 0x00(0x10)
...
// Size: 0x10 (Inherited: 0x00)
struct FFilePath {
	FString FilePath; // 0x00(0x10)
};

// ScriptStruct Engine.EditorMapPerformanceTestDefinition
// Size: 0x20 (Inherited: 0x00)
struct FEditorMapPerformanceTestDefinition {
	FSoftObjectPath PerformanceTestmap; // 0x00(0x18)
...
struct FBuildPromotionTestSettings {
	FFilePath DefaultStaticMeshAsset; // 0x00(0x10)
...
struct FBuildPromotionNewProjectSettings {
	FDirectoryPath NewProjectFolderOverride; // 0x00(0x10)
...
struct FBuildPromotionOpenAssetSettings {
	FFilePath BlueprintAsset; // 0x00(0x10)
...
struct FBuildPromotionImportWorkflowSettings {
	FEditorImportWorkflowDefinition Diffuse; // 0x00(0x20)
...
struct FEditorImportWorkflowDefinition {
	FFilePath ImportFilePath; // 0x00(0x10)
...
struct FBlueprintEditorPromotionSettings {
	FFilePath FirstMeshPath; // 0x00(0x10)
...
struct FParticleEditorPromotionSettings {
	FFilePath DefaultParticleAsset; // 0x00(0x10)
};

// ScriptStruct Engine.MaterialEditorPromotionSettings
// Size: 0x30 (Inherited: 0x00)
struct FMaterialEditorPromotionSettings {
	FFilePath DefaultMaterialAsset; // 0x00(0x10)
...
struct FBandwidthTestGenerator {
	TArray<FBandwidthTestItem> ReplicatedBuffers; // 0x00(0x10)
};

// ScriptStruct Engine.BandwidthTestItem
// Size: 0x10 (Inherited: 0x00)
struct FBandwidthTestItem {
	TArray<char> Kilobyte; // 0x00(0x10)
};

// ScriptStruct Engine.BlendProfileBoneEntry
// Size: 0x14 (Inherited: 0x00)
struct FBlendProfileBoneEntry {
	FBoneReference BoneReference; // 0x00(0x10)
...
struct FGridBlendSample {
	FEditorElement GridElement; // 0x00(0x18)
	float BlendWeight; // 0x18(0x04)
};
...
// Size: 0x18 (Inherited: 0x00)
struct FBlendSample {
	UAnimSequence* Animation; // 0x00(0x08)
	FVector SampleValue; // 0x08(0x0c)
...
struct FBPEditorBookmarkNode {
	FGuid NodeGuid; // 0x00(0x10)
	FGuid ParentGuid; // 0x10(0x10)
	FText DisplayName; // 0x20(0x18)
};

// ScriptStruct Engine.EditedDocumentInfo
// Size: 0x30 (Inherited: 0x00)
struct FEditedDocumentInfo {
	FSoftObjectPath EditedObjectPath; // 0x00(0x18)
	FVector2D SavedViewOffset; // 0x18(0x08)
	float SavedZoomAmount; // 0x20(0x04)
	UObject* EditedObject; // 0x28(0x08)
};

// ScriptStruct Engine.BPInterfaceDescription
// Size: 0x18 (Inherited: 0x00)
struct FBPInterfaceDescription {
	UInterface* Interface; // 0x00(0x08)
	TArray<UEdGraph*> Graphs; // 0x08(0x10)
};

// ScriptStruct Engine.BPVariableDescription
// Size: 0xd0 (Inherited: 0x00)
struct FBPVariableDescription {
	FName VarName; // 0x00(0x08)
	FGuid VarGuid; // 0x08(0x10)
	FEdGraphPinType VarType; // 0x18(0x58)
	FString FriendlyName; // 0x70(0x10)
	FText Category; // 0x80(0x18)
	uint64_t PropertyFlags; // 0x98(0x08)
	FName RepNotifyFunc; // 0xa0(0x08)
	enum class ELifetimeCondition ReplicationCondition; // 0xa8(0x01)
	TArray<FBPVariableMetaDataEntry> MetaDataArray; // 0xb0(0x10)
	FString DefaultValue; // 0xc0(0x10)
};

// ScriptStruct Engine.BPVariableMetaDataEntry
// Size: 0x18 (Inherited: 0x00)
struct FBPVariableMetaDataEntry {
	FName DataKey; // 0x00(0x08)
	FString DataValue; // 0x08(0x10)
};

// ScriptStruct Engine.EdGraphPinType
// Size: 0x58 (Inherited: 0x00)
struct FEdGraphPinType {
	FName PinCategory; // 0x00(0x08)
	FName PinSubCategory; // 0x08(0x08)
	TWeakObjectPtr<UObject> PinSubCategoryObject; // 0x10(0x08)
	FSimpleMemberReference PinSubCategoryMemberReference; // 0x18(0x20)
	FEdGraphTerminalType PinValueType; // 0x38(0x1c)
...
struct FEdGraphTerminalType {
	FName TerminalCategory; // 0x00(0x08)
	FName TerminalSubCategory; // 0x08(0x08)
	TWeakObjectPtr<UObject> TerminalSubCategoryObject; // 0x10(0x08)
...
struct FCompilerNativizationOptions {
	FName PlatformName; // 0x00(0x08)
	bool ServerOnlyPlatform; // 0x08(0x01)
	bool ClientOnlyPlatform; // 0x09(0x01)
	bool bExcludeMonolithicHeaders; // 0x0a(0x01)
	TArray<FName> ExcludedModules; // 0x10(0x10)
	TSet<FSoftObjectPath> ExcludedAssets; // 0x20(0x50)
	TArray<FString> ExcludedFolderPaths; // 0x70(0x10)
};

// ScriptStruct Engine.BPComponentClassOverride
// Size: 0x10 (Inherited: 0x00)
struct FBPComponentClassOverride {
	FName ComponentName; // 0x00(0x08)
	UObject* ComponentClass; // 0x08(0x08)
};

// ScriptStruct Engine.BlueprintCookedComponentInstancingData
// Size: 0x48 (Inherited: 0x00)
struct FBlueprintCookedComponentInstancingData {
	TArray<FBlueprintComponentChangedPropertyInfo> ChangedPropertyList; // 0x00(0x10)
...
struct FBlueprintComponentChangedPropertyInfo {
	...
	UStruct* PropertyScope; // 0x10(0x08)
};

// ScriptStruct Engine.EventGraphFastCallPair
// Size: 0x10 (Inherited: 0x00)
struct FEventGraphFastCallPair {
	UFunction* FunctionToPatch; // 0x00(0x08)
...
// Size: 0x20 (Inherited: 0x00)
struct FBuilderPoly {
	TArray<int32_t> VertexIndices; // 0x00(0x10)
	int32_t Direction; // 0x10(0x04)
	FName ItemName; // 0x14(0x08)
...
struct FCachedAnimTransitionData {
	FName StateMachineName; // 0x00(0x08)
	FName FromStateName; // 0x08(0x08)
	FName ToStateName; // 0x10(0x08)
};
...
struct FCachedAnimStateArray {
	TArray<FCachedAnimStateData> States; // 0x00(0x10)
};
...
struct FActiveCameraShakeInfo {
	UCameraShake* ShakeInstance; // 0x00(0x08)
	TWeakObjectPtr<UCameraShakeSourceComponent> ShakeSource; // 0x08(0x08)
};

// ScriptStruct Engine.PooledCameraShakes
// Size: 0x10 (Inherited: 0x00)
struct FPooledCameraShakes {
	TArray<UCameraShake*> PooledShakes; // 0x00(0x10)
};

// ScriptStruct Engine.VOscillator
// Size: 0x24 (Inherited: 0x00)
struct FVOscillator {
	FFOscillator X; // 0x00(0x0c)
	FFOscillator Y; // 0x0c(0x0c)
	FFOscillator Z; // 0x18(0x0c)
};
...
// Size: 0x24 (Inherited: 0x00)
struct FROscillator {
	FFOscillator Pitch; // 0x00(0x0c)
	FFOscillator Yaw; // 0x0c(0x0c)
	FFOscillator Roll; // 0x18(0x0c)
};
...
struct FMinimalViewInfo {
	...
	FPostProcessSettings PostProcessSettings; // 0x40(0x540)
	FVector2D OffCenterProjectionOffset; // 0x580(0x08)
};
...
struct FPostProcessSettings {
	...
	FVector4 ColorSaturation; // 0x30(0x10)
	FVector4 ColorContrast; // 0x40(0x10)
	FVector4 ColorGamma; // 0x50(0x10)
	FVector4 ColorGain; // 0x60(0x10)
	FVector4 ColorOffset; // 0x70(0x10)
	FVector4 ColorSaturationShadows; // 0x80(0x10)
	FVector4 ColorContrastShadows; // 0x90(0x10)
	FVector4 ColorGammaShadows; // 0xa0(0x10)
	FVector4 ColorGainShadows; // 0xb0(0x10)
	FVector4 ColorOffsetShadows; // 0xc0(0x10)
	FVector4 ColorSaturationMidtones; // 0xd0(0x10)
	FVector4 ColorContrastMidtones; // 0xe0(0x10)
	FVector4 ColorGammaMidtones; // 0xf0(0x10)
	FVector4 ColorGainMidtones; // 0x100(0x10)
	FVector4 ColorOffsetMidtones; // 0x110(0x10)
	FVector4 ColorSaturationHighlights; // 0x120(0x10)
	FVector4 ColorContrastHighlights; // 0x130(0x10)
	FVector4 ColorGammaHighlights; // 0x140(0x10)
	FVector4 ColorGainHighlights; // 0x150(0x10)
	FVector4 ColorOffsetHighlights; // 0x160(0x10)
	...
	FLinearColor FilmWhitePoint; // 0x194(0x10)
	FLinearColor FilmShadowTint; // 0x1a4(0x10)
	float FilmShadowTintBlend; // 0x1b4(0x04)
	float FilmShadowTintAmount; // 0x1b8(0x04)
	float FilmSaturation; // 0x1bc(0x04)
	FLinearColor FilmChannelMixerRed; // 0x1c0(0x10)
	FLinearColor FilmChannelMixerGreen; // 0x1d0(0x10)
	FLinearColor FilmChannelMixerBlue; // 0x1e0(0x10)
	...
	FLinearColor SceneColorTint; // 0x200(0x10)
	...
	FLinearColor Bloom1Tint; // 0x23c(0x10)
	FLinearColor Bloom2Tint; // 0x24c(0x10)
	FLinearColor Bloom3Tint; // 0x25c(0x10)
	FLinearColor Bloom4Tint; // 0x26c(0x10)
	FLinearColor Bloom5Tint; // 0x27c(0x10)
	FLinearColor Bloom6Tint; // 0x28c(0x10)
	float BloomConvolutionSize; // 0x29c(0x04)
	UTexture2D* BloomConvolutionTexture; // 0x2a0(0x08)
	FVector2D BloomConvolutionCenterUV; // 0x2a8(0x08)
	...
	UTexture* BloomDirtMask; // 0x2c0(0x08)
	float BloomDirtMaskIntensity; // 0x2c8(0x04)
	FLinearColor BloomDirtMaskTint; // 0x2cc(0x10)
	FLinearColor AmbientCubemapTint; // 0x2dc(0x10)
	float AmbientCubemapIntensity; // 0x2ec(0x04)
	UTextureCube* AmbientCubemap; // 0x2f0(0x08)
	...
	UCurveFloat* AutoExposureBiasCurve; // 0x320(0x08)
	UTexture* AutoExposureMeterMask; // 0x328(0x08)
	...
	FLinearColor LensFlareTint; // 0x358(0x10)
	float LensFlareBokehSize; // 0x368(0x04)
	float LensFlareThreshold; // 0x36c(0x04)
	UTexture* LensFlareBokehShape; // 0x370(0x08)
	FLinearColor LensFlareTints[0x8]; // 0x378(0x80)
	...
	FLinearColor IndirectLightingColor; // 0x440(0x10)
	...
	UTexture* ColorGradingLUT; // 0x468(0x08)
	...
	FWeightedBlendables WeightedBlendables; // 0x530(0x10)
};

// ScriptStruct Engine.WeightedBlendables
// Size: 0x10 (Inherited: 0x00)
struct FWeightedBlendables {
	TArray<FWeightedBlendable> Array; // 0x00(0x10)
};
...
struct FWeightedBlendable {
	...
	UObject* Object; // 0x08(0x08)
};

// ScriptStruct Engine.CanvasIcon
// Size: 0x18 (Inherited: 0x00)
struct FCanvasIcon {
	UTexture* Texture; // 0x00(0x08)
	float U; // 0x08(0x04)
	float V; // 0x0c(0x04)
	float UL; // 0x10(0x04)
	float VL; // 0x14(0x04)
...
struct FWrappedStringElement {
	...
	FVector2D LineExtent; // 0x10(0x08)
};
...
struct FTextSizingParameters {
	...
	FVector2D Scaling; // 0x10(0x08)
	UFont* DrawFont; // 0x18(0x08)
	FVector2D SpacingAdjust; // 0x20(0x08)
};

// ScriptStruct Engine.BasedMovementInfo
// Size: 0x30 (Inherited: 0x00)
struct FBasedMovementInfo {
	UPrimitiveComponent* MovementBase; // 0x00(0x08)
	FName BoneName; // 0x08(0x08)
	FVector_NetQuantize100 Location; // 0x10(0x0c)
...
struct FSimulatedRootMotionReplicatedMove {
	...
	FRepRootMotionMontage RootMotion; // 0x08(0x98)
};
...
struct FRepRootMotionMontage {
	...
	UAnimMontage* AnimMontage; // 0x08(0x08)
	float Position; // 0x10(0x04)
	FVector_NetQuantize100 Location; // 0x14(0x0c)
	FRotator Rotation; // 0x20(0x0c)
	UPrimitiveComponent* MovementBase; // 0x30(0x08)
	FName MovementBaseBoneName; // 0x38(0x08)
	bool bRelativePosition; // 0x40(0x01)
	bool bRelativeRotation; // 0x41(0x01)
	FRootMotionSourceGroup AuthoritativeRootMotion; // 0x48(0x38)
	FVector_NetQuantize10 Acceleration; // 0x80(0x0c)
	FVector_NetQuantize10 LinearVelocity; // 0x8c(0x0c)
};
...
struct FRootMotionSourceGroup {
	...
	FRootMotionSourceSettings LastAccumulatedSettings; // 0x29(0x01)
	FVector_NetQuantize10 LastPreAdditiveVelocity; // 0x2c(0x0c)
};
...
struct FFindFloorResult {
	...
	FHitResult HitResult; // 0x0c(0x88)
};
...
struct FChildActorComponentInstanceData : FSceneComponentInstanceData {
	AActor* ChildActorClass; // 0xa8(0x08)
	FName ChildActorName; // 0xb0(0x08)
	TArray<FChildActorAttachedActorInfo> AttachedActors; // 0xb8(0x10)
};
...
struct FChildActorAttachedActorInfo {
	...
	FName SocketName; // 0x08(0x08)
	FTransform RelativeTransform; // 0x10(0x30)
};
...
struct FCustomProfile {
	FName Name; // 0x00(0x08)
	TArray<FResponseChannel> CustomResponses; // 0x08(0x10)
};
...
struct FCollisionResponseTemplate {
	...
	FName ObjectTypeName; // 0x2c(0x08)
	TArray<FResponseChannel> CustomResponses; // 0x38(0x10)
};

// ScriptStruct Engine.BlueprintComponentDelegateBinding
// Size: 0x18 (Inherited: 0x00)
struct FBlueprintComponentDelegateBinding {
	FName ComponentPropertyName; // 0x00(0x08)
	FName DelegatePropertyName; // 0x08(0x08)
	FName FunctionNameToBind; // 0x10(0x08)
};
...
struct FAutoCompleteNode {
	...
	TArray<int32_t> AutoCompleteListIndices; // 0x08(0x10)
};

// ScriptStruct Engine.AngularDriveConstraint
// Size: 0x4c (Inherited: 0x00)
struct FAngularDriveConstraint {
	FConstraintDrive TwistDrive; // 0x00(0x10)
	FConstraintDrive SwingDrive; // 0x10(0x10)
	FConstraintDrive SlerpDrive; // 0x20(0x10)
	FRotator OrientationTarget; // 0x30(0x0c)
	FVector AngularVelocityTarget; // 0x3c(0x0c)
...
struct FLinearDriveConstraint {
	FVector PositionTarget; // 0x00(0x0c)
	FVector VelocityTarget; // 0x0c(0x0c)
	FConstraintDrive XDrive; // 0x18(0x10)
	FConstraintDrive YDrive; // 0x28(0x10)
	FConstraintDrive ZDrive; // 0x38(0x10)
...
struct FConstraintInstance {
	FName JointName; // 0x18(0x08)
	FName ConstraintBone1; // 0x20(0x08)
	FName ConstraintBone2; // 0x28(0x08)
	FVector Pos1; // 0x30(0x0c)
	FVector PriAxis1; // 0x3c(0x0c)
	FVector SecAxis1; // 0x48(0x0c)
	FVector Pos2; // 0x54(0x0c)
	FVector PriAxis2; // 0x60(0x0c)
	FVector SecAxis2; // 0x6c(0x0c)
	FRotator AngularRotationOffset; // 0x78(0x0c)
	char bScaleLinearLimits : 1; // 0x84(0x01)
	FConstraintProfileProperties ProfileInstance; // 0x8c(0x104)
};
...
struct FConstraintProfileProperties {
	...
	FLinearConstraint LinearLimit; // 0x10(0x1c)
	FConeConstraint ConeLimit; // 0x2c(0x20)
	FTwistConstraint TwistLimit; // 0x4c(0x1c)
	FLinearDriveConstraint LinearDrive; // 0x68(0x4c)
	FAngularDriveConstraint AngularDrive; // 0xb4(0x4c)
...
struct FRuntimeCurveLinearColor {
	FRichCurve ColorCurves[0x4]; // 0x00(0x200)
	UCurveLinearColor* ExternalCurve; // 0x200(0x08)
};
...
struct FCurveTableRowHandle {
	UCurveTable* CurveTable; // 0x00(0x08)
...
struct FDataTableCategoryHandle {
	UDataTable* DataTable; // 0x00(0x08)
	FName ColumnName; // 0x08(0x08)
	FName RowContents; // 0x10(0x08)
};
...
struct FDebugDisplayProperty {
	UObject* Obj; // 0x00(0x08)
	UObject* WithinClass; // 0x08(0x08)
};

// ScriptStruct Engine.DebugTextInfo
// Size: 0x60 (Inherited: 0x00)
struct FDebugTextInfo {
	AActor* SrcActor; // 0x00(0x08)
	FVector SrcActorOffset; // 0x08(0x0c)
	FVector SrcActorDesiredOffset; // 0x14(0x0c)
	FString DebugText; // 0x20(0x10)
	float TimeRemaining; // 0x30(0x04)
	float Duration; // 0x34(0x04)
	FColor TextColor; // 0x38(0x04)
	char bAbsoluteLocation : 1; // 0x3c(0x01)
	char bKeepAttachedToActor : 1; // 0x3c(0x01)
	char bDrawShadow : 1; // 0x3c(0x01)
	FVector OrigActorLocation; // 0x40(0x0c)
	UFont* Font; // 0x50(0x08)
...
struct FMulticastRecordOptions {
	FString FuncPathName; // 0x00(0x10)
...
struct FRollbackNetStartupActorInfo {
	UObject* Archetype; // 0x08(0x08)
	ULevel* Level; // 0x38(0x08)
	TArray<UObject*> ObjReferences; // 0xa0(0x10)
};

// ScriptStruct Engine.LevelNameAndTime
// Size: 0x18 (Inherited: 0x00)
struct FLevelNameAndTime {
	FString LevelName; // 0x00(0x10)
...
struct FDialogueWaveParameter {
	UDialogueWave* DialogueWave; // 0x00(0x08)
	FDialogueContext Context; // 0x08(0x18)
};

// ScriptStruct Engine.DialogueContext
// Size: 0x18 (Inherited: 0x00)
struct FDialogueContext {
	UDialogueVoice* Speaker; // 0x00(0x08)
	TArray<UDialogueVoice*> Targets; // 0x08(0x10)
};

// ScriptStruct Engine.DialogueContextMapping
// Size: 0x38 (Inherited: 0x00)
struct FDialogueContextMapping {
	FDialogueContext Context; // 0x00(0x18)
	USoundWave* SoundWave; // 0x18(0x08)
	FString LocalizationKeyFormat; // 0x20(0x10)
	UDialogueSoundWaveProxy* Proxy; // 0x30(0x08)
};
...
struct FRawDistributionFloat : FRawDistribution {
	...
	UDistributionFloat* Distribution; // 0x28(0x08)
};
...
struct FRawDistributionVector : FRawDistribution {
	float MinValue; // 0x20(0x04)
	float MaxValue; // 0x24(0x04)
	FVector MinValueVec; // 0x28(0x0c)
	FVector MaxValueVec; // 0x34(0x0c)
	UDistributionVector* Distribution; // 0x40(0x08)
};

// ScriptStruct Engine.GraphReference
// Size: 0x20 (Inherited: 0x00)
struct FGraphReference {
	UEdGraph* MacroGraph; // 0x00(0x08)
	UBlueprint* GraphBlueprint; // 0x08(0x08)
...
struct FEdGraphPinReference {
	TWeakObjectPtr<UEdGraphNode> OwningNode; // 0x00(0x08)
	FGuid PinID; // 0x08(0x10)
};

// ScriptStruct Engine.EdGraphSchemaAction
// Size: 0x100 (Inherited: 0x00)
struct FEdGraphSchemaAction {
	FText MenuDescription; // 0x08(0x18)
	FText TooltipDescription; // 0x20(0x18)
	FText Category; // 0x38(0x18)
	FText Keywords; // 0x50(0x18)
	int32_t Grouping; // 0x68(0x04)
	int32_t SectionID; // 0x6c(0x04)
	TArray<FString> MenuDescriptionArray; // 0x70(0x10)
	TArray<FString> FullSearchTitlesArray; // 0x80(0x10)
	TArray<FString> FullSearchKeywordsArray; // 0x90(0x10)
	TArray<FString> FullSearchCategoryArray; // 0xa0(0x10)
	TArray<FString> LocalizedMenuDescriptionArray; // 0xb0(0x10)
	TArray<FString> LocalizedFullSearchTitlesArray; // 0xc0(0x10)
	TArray<FString> LocalizedFullSearchKeywordsArray; // 0xd0(0x10)
	TArray<FString> LocalizedFullSearchCategoryArray; // 0xe0(0x10)
	FString SearchText; // 0xf0(0x10)
};

// ScriptStruct Engine.EdGraphSchemaAction_NewNode
// Size: 0x108 (Inherited: 0x100)
struct FEdGraphSchemaAction_NewNode : FEdGraphSchemaAction {
	UEdGraphNode* NodeTemplate; // 0x100(0x08)
};

// ScriptStruct Engine.PluginRedirect
// Size: 0x20 (Inherited: 0x00)
struct FPluginRedirect {
	FString OldPluginName; // 0x00(0x10)
...
struct FStructRedirect {
	FName OldStructName; // 0x00(0x08)
	FName NewStructName; // 0x08(0x08)
};

// ScriptStruct Engine.ClassRedirect
// Size: 0x3c (Inherited: 0x00)
struct FClassRedirect {
	FName ObjectName; // 0x00(0x08)
	FName OldClassName; // 0x08(0x08)
	FName NewClassName; // 0x10(0x08)
	FName OldSubobjName; // 0x18(0x08)
	FName NewSubobjName; // 0x20(0x08)
	FName NewClassClass; // 0x28(0x08)
	FName NewClassPackage; // 0x30(0x08)
...
struct FGameNameRedirect {
	FName OldGameName; // 0x00(0x08)
	FName NewGameName; // 0x08(0x08)
};
...
struct FScreenMessageString {
	...
	FString ScreenMessage; // 0x08(0x10)
	FColor DisplayColor; // 0x18(0x04)
	float TimeToDisplay; // 0x1c(0x04)
	float CurrentTimeDisplayed; // 0x20(0x04)
	FVector2D TextScale; // 0x24(0x08)
};
...
struct FDropNoteInfo {
	FVector Location; // 0x00(0x0c)
	FRotator Rotation; // 0x0c(0x0c)
	FString Comment; // 0x18(0x10)
};

// ScriptStruct Engine.StatColorMapping
// Size: 0x28 (Inherited: 0x00)
struct FStatColorMapping {
	FString StatName; // 0x00(0x10)
...
struct FStatColorMapEntry {
	float In; // 0x00(0x04)
	FColor Out; // 0x04(0x04)
};

// ScriptStruct Engine.WorldContext
// Size: 0x280 (Inherited: 0x00)
struct FWorldContext {
	FURL LastURL; // 0xd0(0x68)
	FURL LastRemoteURL; // 0x138(0x68)
	UPendingNetGame* PendingNetGame; // 0x1a0(0x08)
	TArray<FFullyLoadedPackagesInfo> PackagesToFullyLoad; // 0x1a8(0x10)
	TArray<ULevel*> LoadedLevelsForPendingMapChange; // 0x1c8(0x10)
	TArray<UObjectReferencer*> ObjectReferencers; // 0x1f0(0x10)
	TArray<FLevelStreamingStatus> PendingLevelStreamingStatusUpdates; // 0x200(0x10)
	UGameViewportClient* GameViewport; // 0x210(0x08)
	UGameInstance* OwningGameInstance; // 0x218(0x08)
	TArray<FNamedNetDriver> ActiveNetDrivers; // 0x220(0x10)
};

// ScriptStruct Engine.NamedNetDriver
// Size: 0x10 (Inherited: 0x00)
struct FNamedNetDriver {
	UNetDriver* NetDriver; // 0x00(0x08)
};

// ScriptStruct Engine.LevelStreamingStatus
// Size: 0x10 (Inherited: 0x00)
struct FLevelStreamingStatus {
	FName PackageName; // 0x00(0x08)
...
struct FNetDriverDefinition {
	FName DefName; // 0x00(0x08)
	FName DriverClassName; // 0x08(0x08)
	FName DriverClassNameFallback; // 0x10(0x08)
};
...
// Size: 0x60 (Inherited: 0x00)
struct FCanvasUVTri {
	FVector2D V0_Pos; // 0x00(0x08)
	FVector2D V0_UV; // 0x08(0x08)
	FLinearColor V0_Color; // 0x10(0x10)
	FVector2D V1_Pos; // 0x20(0x08)
	FVector2D V1_UV; // 0x28(0x08)
	FLinearColor V1_Color; // 0x30(0x10)
	FVector2D V2_Pos; // 0x40(0x08)
	FVector2D V2_UV; // 0x48(0x08)
	FLinearColor V2_Color; // 0x50(0x10)
};
...
struct FFontRenderInfo {
	...
	FDepthFieldGlowInfo GlowInfo; // 0x04(0x24)
};
...
struct FDepthFieldGlowInfo {
	...
	FLinearColor GlowColor; // 0x04(0x10)
	FVector2D GlowOuterRadius; // 0x14(0x08)
	FVector2D GlowInnerRadius; // 0x1c(0x08)
};

// ScriptStruct Engine.Redirector
// Size: 0x10 (Inherited: 0x00)
struct FRedirector {
	FName OldName; // 0x00(0x08)
	FName NewName; // 0x08(0x08)
};

// ScriptStruct Engine.CollectionReference
// Size: 0x08 (Inherited: 0x00)
struct FCollectionReference {
	FName CollectionName; // 0x00(0x08)
};

// ScriptStruct Engine.ComponentReference
// Size: 0x28 (Inherited: 0x00)
struct FComponentReference {
	AActor* OtherActor; // 0x00(0x08)
	FName ComponentProperty; // 0x08(0x08)
	FString PathToComponent; // 0x10(0x10)
};
...
// Size: 0x10 (Inherited: 0x00)
struct FDamageEvent {
	UDamageType* DamageTypeClass; // 0x08(0x08)
};
...
struct FRadialDamageEvent : FDamageEvent {
	...
	FVector Origin; // 0x24(0x0c)
	TArray<FHitResult> ComponentHits; // 0x30(0x10)
};
...
struct FPointDamageEvent : FDamageEvent {
	...
	FVector_NetQuantizeNormal ShotDirection; // 0x14(0x0c)
	FHitResult HitInfo; // 0x20(0x88)
};
...
struct FMeshBuildSettings {
	...
	FVector BuildScale3D; // 0x14(0x0c)
	float DistanceFieldResolutionScale; // 0x20(0x04)
	UStaticMesh* DistanceFieldReplacementMesh; // 0x28(0x08)
};
...
struct FAnimSlotInfo {
	FName SlotName; // 0x00(0x08)
	TArray<float> ChannelWeights; // 0x08(0x10)
};
...
struct FOverlapResult {
	TWeakObjectPtr<AActor> Actor; // 0x00(0x08)
	TWeakObjectPtr<UPrimitiveComponent> Component; // 0x08(0x08)
...
struct FPrimitiveMaterialRef {
	UPrimitiveComponent* Primitive; // 0x00(0x08)
	UDecalComponent* Decal; // 0x08(0x08)
...
struct FBasedPosition {
	AActor* Base; // 0x00(0x08)
	FVector Position; // 0x08(0x0c)
	FVector CachedBaseLocation; // 0x14(0x0c)
	FRotator CachedBaseRotation; // 0x20(0x0c)
	FVector CachedTransPosition; // 0x2c(0x0c)
};
...
struct FFractureEffect {
	...
	USoundBase* Sound; // 0x08(0x08)
};

// ScriptStruct Engine.CollisionImpactData
// Size: 0x28 (Inherited: 0x00)
struct FCollisionImpactData {
	TArray<FRigidBodyContactInfo> ContactInfos; // 0x00(0x10)
	FVector TotalNormalImpulse; // 0x10(0x0c)
	FVector TotalFrictionImpulse; // 0x1c(0x0c)
};

// ScriptStruct Engine.RigidBodyContactInfo
// Size: 0x30 (Inherited: 0x00)
struct FRigidBodyContactInfo {
	FVector ContactPosition; // 0x00(0x0c)
	FVector ContactNormal; // 0x0c(0x0c)
	float ContactPenetration; // 0x18(0x04)
	UPhysicalMaterial* PhysMaterial[0x2]; // 0x20(0x10)
};
...
struct FRigidBodyState {
	FVector_NetQuantize100 Position; // 0x00(0x0c)
	FQuat Quaternion; // 0x10(0x10)
	FVector_NetQuantize100 LinVel; // 0x20(0x0c)
	FVector_NetQuantize100 AngVel; // 0x2c(0x0c)
...
struct FActiveForceFeedbackEffect {
	UForceFeedbackEffect* ForceFeedbackEffect; // 0x00(0x08)
};
...
struct FForceFeedbackChannelDetails {
	...
	FRuntimeFloatCurve Curve; // 0x08(0x88)
};

// ScriptStruct Engine.PredictProjectilePathResult
// Size: 0xb8 (Inherited: 0x00)
struct FPredictProjectilePathResult {
	TArray<FPredictProjectilePathPointData> PathData; // 0x00(0x10)
	FPredictProjectilePathPointData LastTraceDestination; // 0x10(0x1c)
	FHitResult HitResult; // 0x2c(0x88)
};
...
struct FPredictProjectilePathParams {
	...
	FVector LaunchVelocity; // 0x0c(0x0c)
	...
	TArray<enum class EObjectTypeQuery> ObjectTypes; // 0x28(0x10)
	TArray<AActor*> ActorsToIgnore; // 0x38(0x10)
...
struct FActiveHapticFeedbackEffect {
	UHapticFeedbackEffect_Base* HapticEffect; // 0x00(0x08)
};

// ScriptStruct Engine.HapticFeedbackDetails_Curve
// Size: 0x110 (Inherited: 0x00)
struct FHapticFeedbackDetails_Curve {
	FRuntimeFloatCurve Frequency; // 0x00(0x88)
...
// Size: 0x40 (Inherited: 0x00)
struct FClusterNode {
	FVector BoundMin; // 0x00(0x0c)
	int32_t FirstChild; // 0x0c(0x04)
	FVector BoundMax; // 0x10(0x0c)
	int32_t LastChild; // 0x1c(0x04)
	int32_t FirstInstance; // 0x20(0x04)
	int32_t LastInstance; // 0x24(0x04)
	FVector MinInstanceScale; // 0x28(0x0c)
	FVector MaxInstanceScale; // 0x34(0x0c)
};
...
struct FHLODProxyMesh {
	...
	UStaticMesh* StaticMesh; // 0x20(0x08)
	FName Key; // 0x28(0x08)
};
...
struct FImportanceTexture {
	...
	TWeakObjectPtr<UTexture2D> Texture; // 0x40(0x08)
...
struct FComponentOverrideRecord {
	UObject* ComponentClass; // 0x00(0x08)
	UActorComponent* ComponentTemplate; // 0x08(0x08)
...
struct FComponentKey {
	UObject* OwnerClass; // 0x00(0x08)
	FName SCSVariableName; // 0x08(0x08)
	FGuid AssociatedGuid; // 0x10(0x10)
};
...
struct FBlueprintInputActionDelegateBinding : FBlueprintInputDelegateBinding {
	FName InputActionName; // 0x04(0x08)
...
struct FBlueprintInputTouchDelegateBinding : FBlueprintInputDelegateBinding {
	...
	FName FunctionNameToBind; // 0x08(0x08)
};
...
struct FInstancedStaticMeshComponentInstanceData : FSceneComponentInstanceData {
	UStaticMesh* StaticMesh; // 0xa8(0x08)
	FInstancedStaticMeshLightMapInstanceData CachedStaticLighting; // 0xb0(0x40)
	TArray<FInstancedStaticMeshInstanceData> PerInstanceSMData; // 0xf0(0x10)
	TArray<float> PerInstanceSMCustomData; // 0x100(0x10)
...
struct FInstancedStaticMeshLightMapInstanceData {
	FTransform Transform; // 0x00(0x30)
	TArray<FGuid> MapBuildDataIds; // 0x30(0x10)
};
...
struct FCurveEdEntry {
	UObject* CurveObject; // 0x00(0x08)
	FColor CurveColor; // 0x08(0x04)
...
struct FInterpEdSelKey {
	UInterpGroup* Group; // 0x00(0x08)
	UInterpTrack* Track; // 0x08(0x08)
...
struct FCameraPreviewInfo {
	APawn* PawnClass; // 0x00(0x08)
	UAnimSequence* AnimSeq; // 0x08(0x08)
	FVector Location; // 0x10(0x0c)
	FRotator Rotation; // 0x1c(0x0c)
	APawn* PawnInst; // 0x28(0x08)
};

// ScriptStruct Engine.SubTrackGroup
// Size: 0x28 (Inherited: 0x00)
struct FSubTrackGroup {
	FString GroupName; // 0x00(0x10)
	TArray<int32_t> TrackIndices; // 0x10(0x10)
...
struct FSupportedSubTrackInfo {
	UInterpTrack* SupportedClass; // 0x00(0x08)
	FString SubTrackName; // 0x08(0x10)
...
struct FDirectorTrackCut {
	...
	FName TargetCamGroup; // 0x08(0x08)
...
struct FEventTrackKey {
	float Time; // 0x00(0x04)
	FName EventName; // 0x04(0x08)
};

// ScriptStruct Engine.InterpLookupTrack
// Size: 0x10 (Inherited: 0x00)
struct FInterpLookupTrack {
	TArray<FInterpLookupPoint> Points; // 0x00(0x10)
};
...
struct FDrawToRenderTargetContext {
	UTextureRenderTarget2D* RenderTarget; // 0x00(0x08)
};
...
struct FLevelSimplificationDetails {
	...
	FMaterialProxySettings StaticMeshMaterialSettings; // 0x08(0x88)
	bool bOverrideLandscapeExportLOD; // 0x90(0x01)
	int32_t LandscapeExportLOD; // 0x94(0x04)
	FMaterialProxySettings LandscapeMaterialSettings; // 0x98(0x88)
...
struct FMaterialProxySettings {
	FIntPoint TextureSize; // 0x00(0x08)
	...
	FIntPoint DiffuseTextureSize; // 0x30(0x08)
	FIntPoint NormalTextureSize; // 0x38(0x08)
	FIntPoint TangentTextureSize; // 0x40(0x08)
	FIntPoint MetallicTextureSize; // 0x48(0x08)
	FIntPoint RoughnessTextureSize; // 0x50(0x08)
	FIntPoint AnisotropyTextureSize; // 0x58(0x08)
	FIntPoint SpecularTextureSize; // 0x60(0x08)
	FIntPoint EmissiveTextureSize; // 0x68(0x08)
	FIntPoint OpacityTextureSize; // 0x70(0x08)
	FIntPoint OpacityMaskTextureSize; // 0x78(0x08)
	FIntPoint AmbientOcclusionTextureSize; // 0x80(0x08)
};
...
struct FPrecomputedLightInstanceData : FSceneComponentInstanceData {
	FTransform Transform; // 0xb0(0x30)
	FGuid LightGuid; // 0xe0(0x10)
...
struct FClientReceiveData {
	APlayerController* LocalPC; // 0x00(0x08)
	FName MessageType; // 0x08(0x08)
	int32_t MessageIndex; // 0x10(0x04)
	FString MessageString; // 0x18(0x10)
	APlayerState* RelatedPlayerState_2; // 0x28(0x08)
	APlayerState* RelatedPlayerState_3; // 0x30(0x08)
	UObject* OptionalObject; // 0x38(0x08)
};
...
struct FMaterialSpriteElement {
	UMaterialInterface* Material; // 0x00(0x08)
	UCurveFloat* DistanceToOpacityCurve; // 0x08(0x08)
	char bSizeIsInScreenSpace : 1; // 0x10(0x01)
	float BaseSizeX; // 0x14(0x04)
	float BaseSizeY; // 0x18(0x04)
	UCurveFloat* DistanceToSizeCurve; // 0x20(0x08)
};

// ScriptStruct Engine.MaterialCachedExpressionData
// Size: 0x228 (Inherited: 0x00)
struct FMaterialCachedExpressionData {
	FMaterialCachedParameters Parameters; // 0x00(0x1a0)
	TArray<UObject*> ReferencedTextures; // 0x1a0(0x10)
	TArray<FMaterialFunctionInfo> FunctionInfos; // 0x1b0(0x10)
	TArray<FMaterialParameterCollectionInfo> ParameterCollectionInfos; // 0x1c0(0x10)
	TArray<UMaterialFunctionInterface*> DefaultLayers; // 0x1d0(0x10)
	TArray<UMaterialFunctionInterface*> DefaultLayerBlends; // 0x1e0(0x10)
	TArray<ULandscapeGrassType*> GrassTypes; // 0x1f0(0x10)
	TArray<FName> DynamicParameterNames; // 0x200(0x10)
	TArray<bool> QualityLevelsUsed; // 0x210(0x10)
...
struct FMaterialParameterCollectionInfo {
	FGuid StateId; // 0x00(0x10)
	UMaterialParameterCollection* ParameterCollection; // 0x10(0x08)
};
...
struct FMaterialFunctionInfo {
	FGuid StateId; // 0x00(0x10)
	UMaterialFunctionInterface* Function; // 0x10(0x08)
};

// ScriptStruct Engine.MaterialCachedParameters
// Size: 0x1a0 (Inherited: 0x00)
struct FMaterialCachedParameters {
	FMaterialCachedParameterEntry Entries[0x5]; // 0x00(0x140)
	TArray<float> ScalarValues; // 0x140(0x10)
	TArray<FLinearColor> VectorValues; // 0x150(0x10)
	TArray<UTexture*> TextureValues; // 0x160(0x10)
	TArray<UFont*> FontValues; // 0x170(0x10)
	TArray<int32_t> FontPageValues; // 0x180(0x10)
	TArray<URuntimeVirtualTexture*> RuntimeVirtualTextureValues; // 0x190(0x10)
};

// ScriptStruct Engine.MaterialCachedParameterEntry
// Size: 0x40 (Inherited: 0x00)
struct FMaterialCachedParameterEntry {
	TArray<uint64_t> NameHashes; // 0x00(0x10)
	TArray<FMaterialParameterInfo> ParameterInfos; // 0x10(0x10)
	TArray<FGuid> ExpressionGuids; // 0x20(0x10)
	TArray<bool> Overrides; // 0x30(0x10)
};
...
struct FCustomInput {
	...
	FExpressionInput Input; // 0x08(0x0c)
};

// ScriptStruct Engine.FunctionExpressionOutput
// Size: 0x20 (Inherited: 0x00)
struct FFunctionExpressionOutput {
	UMaterialExpressionFunctionOutput* ExpressionOutput; // 0x00(0x08)
	FGuid ExpressionOutputId; // 0x08(0x10)
	FExpressionOutput Output; // 0x18(0x08)
};

// ScriptStruct Engine.FunctionExpressionInput
// Size: 0x30 (Inherited: 0x00)
struct FFunctionExpressionInput {
	UMaterialExpressionFunctionInput* ExpressionInput; // 0x00(0x08)
	FGuid ExpressionInputId; // 0x08(0x10)
	FExpressionInput Input; // 0x18(0x0c)
};

// ScriptStruct Engine.FontParameterValue
// Size: 0x30 (Inherited: 0x00)
struct FFontParameterValue {
	FMaterialParameterInfo ParameterInfo; // 0x00(0x10)
	UFont* FontValue; // 0x10(0x08)
...
struct FRuntimeVirtualTextureParameterValue {
	FMaterialParameterInfo ParameterInfo; // 0x00(0x10)
	URuntimeVirtualTexture* ParameterValue; // 0x10(0x08)
...
struct FTextureParameterValue {
	FMaterialParameterInfo ParameterInfo; // 0x00(0x10)
	UTexture* ParameterValue; // 0x10(0x08)
	FGuid ExpressionGUID; // 0x18(0x10)
};
...
struct FVectorParameterValue {
	...
	FGuid ExpressionGUID; // 0x20(0x10)
};
...
struct FScalarParameterValue {
	...
	FGuid ExpressionGUID; // 0x14(0x10)
};
...
struct FScalarParameterAtlasInstanceData {
	...
	TSoftObjectPtr<UCurveLinearColor> Curve; // 0x08(0x28)
	TSoftObjectPtr<UCurveLinearColorAtlas> Atlas; // 0x30(0x28)
};
...
struct FMaterialLayersFunctions {
	TArray<UMaterialFunctionInterface*> Layers; // 0x00(0x10)
	TArray<UMaterialFunctionInterface*> Blends; // 0x10(0x10)
	TArray<bool> LayerStates; // 0x20(0x10)
	FString KeyString; // 0x30(0x10)
};
...
struct FCollectionVectorParameter : FCollectionParameterBase {
	FLinearColor DefaultValue; // 0x18(0x10)
};
...
struct FInterpGroupActorInfo {
	FName ObjectName; // 0x00(0x08)
	TArray<AActor*> Actors; // 0x08(0x10)
};
...
struct FMemberReference {
	UObject* MemberParent; // 0x00(0x08)
	FString MemberScope; // 0x08(0x10)
	FName MemberName; // 0x18(0x08)
	FGuid MemberGuid; // 0x20(0x10)
...
struct FMeshInstancingSettings {
	AActor* ActorClassToUse; // 0x00(0x08)
	...
	UInstancedStaticMeshComponent* ISMComponentToUse; // 0x10(0x08)
};
...
struct FMeshMergingSettings {
	...
	FMaterialProxySettings MaterialSettings; // 0x0c(0x88)
...
struct FMeshProxySettings {
	...
	FMaterialProxySettings MaterialSettings; // 0x08(0x88)
	float MergeDistance; // 0x90(0x04)
	FColor UnresolvedGeometryColor; // 0x94(0x04)
...
struct FNavDataConfig : FNavAgentProperties {
	FName Name; // 0x30(0x08)
	FColor Color; // 0x38(0x04)
	FVector DefaultQueryExtent; // 0x3c(0x0c)
	AActor* NavigationDataClass; // 0x48(0x08)
	TSoftClassPtr<UObject> NavDataClass; // 0x50(0x28)
};
...
struct FNavigationLinkBase {
	...
	FNavAgentSelector SupportedAgents; // 0x14(0x04)
	...
	UNavAreaBase* AreaClass; // 0x20(0x08)
};

// ScriptStruct Engine.NavigationSegmentLink
// Size: 0x60 (Inherited: 0x30)
struct FNavigationSegmentLink : FNavigationLinkBase {
	FVector LeftStart; // 0x30(0x0c)
	FVector LeftEnd; // 0x3c(0x0c)
	FVector RightStart; // 0x48(0x0c)
	FVector RightEnd; // 0x54(0x0c)
};

// ScriptStruct Engine.NavigationLink
// Size: 0x48 (Inherited: 0x30)
struct FNavigationLink : FNavigationLinkBase {
	FVector Left; // 0x30(0x0c)
	FVector Right; // 0x3c(0x0c)
};

// ScriptStruct Engine.ChannelDefinition
// Size: 0x28 (Inherited: 0x00)
struct FChannelDefinition {
	FName ChannelName; // 0x00(0x08)
	FName ClassName; // 0x08(0x08)
	UObject* ChannelClass; // 0x10(0x08)
...
struct FParticleRandomSeedInfo {
	...
	TArray<int32_t> RandomSeeds; // 0x10(0x10)
};

// ScriptStruct Engine.ParticleCurvePair
// Size: 0x18 (Inherited: 0x00)
struct FParticleCurvePair {
	FString CurveName; // 0x00(0x10)
	UObject* CurveObject; // 0x10(0x08)
};
...
struct FLocationBoneSocketInfo {
	FName BoneSocketName; // 0x00(0x08)
	FVector Offset; // 0x08(0x0c)
};
...
struct FEmitterDynamicParameter {
	...
	FRawDistributionFloat ParamValue; // 0x18(0x30)
};

// ScriptStruct Engine.BeamTargetData
// Size: 0x0c (Inherited: 0x00)
struct FBeamTargetData {
	FName TargetName; // 0x00(0x08)
...
struct FGPUSpriteResourceData {
	TArray<FColor> QuantizedColorSamples; // 0x00(0x10)
	TArray<FColor> QuantizedMiscSamples; // 0x10(0x10)
	TArray<FColor> QuantizedSimulationAttrSamples; // 0x20(0x10)
	FVector4 ColorScale; // 0x30(0x10)
	FVector4 ColorBias; // 0x40(0x10)
	FVector4 MiscScale; // 0x50(0x10)
	FVector4 MiscBias; // 0x60(0x10)
	FVector4 SimulationAttrCurveScale; // 0x70(0x10)
	FVector4 SimulationAttrCurveBias; // 0x80(0x10)
	FVector4 SubImageSize; // 0x90(0x10)
	FVector4 SizeBySpeed; // 0xa0(0x10)
	FVector ConstantAcceleration; // 0xb0(0x0c)
	FVector OrbitOffsetBase; // 0xbc(0x0c)
	FVector OrbitOffsetRange; // 0xc8(0x0c)
	FVector OrbitFrequencyBase; // 0xd4(0x0c)
	FVector OrbitFrequencyRange; // 0xe0(0x0c)
	FVector OrbitPhaseBase; // 0xec(0x0c)
	FVector OrbitPhaseRange; // 0xf8(0x0c)
	...
	FVector2D PivotOffset; // 0x148(0x08)
...
struct FGPUSpriteEmitterInfo {
	UParticleModuleRequired* RequiredModule; // 0x00(0x08)
	UParticleModuleSpawn* SpawnModule; // 0x08(0x08)
	UParticleModuleSpawnPerUnit* SpawnPerUnitModule; // 0x10(0x08)
	TArray<UParticleModule*> SpawnModules; // 0x18(0x10)
	FGPUSpriteLocalVectorFieldInfo LocalVectorField; // 0x30(0x70)
	FFloatDistribution VectorFieldScale; // 0xa0(0x20)
	FFloatDistribution DragCoefficient; // 0xc0(0x20)
	FFloatDistribution PointAttractorStrength; // 0xe0(0x20)
	FFloatDistribution Resilience; // 0x100(0x20)
	FVector ConstantAcceleration; // 0x120(0x0c)
	FVector PointAttractorPosition; // 0x12c(0x0c)
	float PointAttractorRadiusSq; // 0x138(0x04)
	FVector OrbitOffsetBase; // 0x13c(0x0c)
	FVector OrbitOffsetRange; // 0x148(0x0c)
	FVector2D InvMaxSize; // 0x154(0x08)
	...
	FRawDistributionVector DynamicColor; // 0x180(0x48)
	FRawDistributionFloat DynamicAlpha; // 0x1c8(0x30)
	FRawDistributionVector DynamicColorScale; // 0x1f8(0x48)
	FRawDistributionFloat DynamicAlphaScale; // 0x240(0x30)
};

// ScriptStruct Engine.GPUSpriteLocalVectorFieldInfo
// Size: 0x70 (Inherited: 0x00)
struct FGPUSpriteLocalVectorFieldInfo {
	UVectorField* Field; // 0x00(0x08)
	FTransform Transform; // 0x10(0x30)
	FRotator MinInitialRotation; // 0x40(0x0c)
	FRotator MaxInitialRotation; // 0x4c(0x0c)
	FRotator RotationRate; // 0x58(0x0c)
...
struct FLODSoloTrack {
	TArray<char> SoloEnableSetting; // 0x00(0x10)
};
...
struct FParticleSysParam {
	...
	FVector Vector; // 0x14(0x0c)
	FVector Vector_Low; // 0x20(0x0c)
	FColor Color; // 0x2c(0x04)
	AActor* Actor; // 0x30(0x08)
	UMaterialInterface* Material; // 0x38(0x08)
};
...
struct FPhysicalAnimationProfile {
	...
	FPhysicalAnimationData PhysicalAnimationData; // 0x08(0x24)
};

// ScriptStruct Engine.PhysicsConstraintProfileHandle
// Size: 0x10c (Inherited: 0x00)
struct FPhysicsConstraintProfileHandle {
	FConstraintProfileProperties ProfileProperties; // 0x00(0x104)
	FName ProfileName; // 0x104(0x08)
};
...
struct FDelegateArray {
	TArray<FDelegate> Delegates; // 0x00(0x10)
};
...
struct FTViewTarget {
	...
	FMinimalViewInfo POV; // 0x10(0x5d0)
	APlayerState* PlayerState; // 0x5e0(0x08)
};
...
struct FInputActionSpeechMapping {
	...
	FName SpeechKeyword; // 0x08(0x08)
};

// ScriptStruct Engine.InputAxisKeyMapping
// Size: 0x28 (Inherited: 0x00)
struct FInputAxisKeyMapping {
	FName AxisName; // 0x00(0x08)
...
struct FInputAxisConfigEntry {
	FName AxisKeyName; // 0x00(0x08)
	FInputAxisProperties AxisProperties; // 0x08(0x10)
};
...
struct FPoseDataContainer {
	TArray<FSmartName> PoseNames; // 0x00(0x10)
	TArray<FName> Tracks; // 0x10(0x10)
	TMap<FName, int32_t> TrackMap; // 0x20(0x50)
	TArray<FPoseData> Poses; // 0x70(0x10)
	TArray<FAnimCurveBase> Curves; // 0x80(0x10)
};

// ScriptStruct Engine.PoseData
// Size: 0x70 (Inherited: 0x00)
struct FPoseData {
	TArray<FTransform> LocalSpacePose; // 0x00(0x10)
	TMap<int32_t, int32_t> TrackToBufferIndex; // 0x10(0x50)
	TArray<float> CurveData; // 0x60(0x10)
};

// ScriptStruct Engine.PreviewAssetAttachContainer
// Size: 0x10 (Inherited: 0x00)
struct FPreviewAssetAttachContainer {
	TArray<FPreviewAttachedObjectPair> AttachedObjects; // 0x00(0x10)
};

// ScriptStruct Engine.PreviewAttachedObjectPair
// Size: 0x38 (Inherited: 0x00)
struct FPreviewAttachedObjectPair {
	TSoftObjectPtr<UObject> AttachedObject; // 0x00(0x28)
	UObject* Object; // 0x28(0x08)
	FName AttachedTo; // 0x30(0x08)
};

// ScriptStruct Engine.PreviewMeshCollectionEntry
// Size: 0x28 (Inherited: 0x00)
struct FPreviewMeshCollectionEntry {
	TSoftObjectPtr<USkeletalMesh> SkeletalMesh; // 0x00(0x28)
};
...
struct FPrimitiveComponentInstanceData : FSceneComponentInstanceData {
	FTransform ComponentTransform; // 0xb0(0x30)
	int32_t VisibilityId; // 0xe0(0x04)
	UPrimitiveComponent* LODParent; // 0xe8(0x08)
};
...
struct FReverbSettings {
	...
	UReverbEffect* ReverbEffect; // 0x08(0x08)
	USoundEffectSubmixPreset* ReverbPluginEffect; // 0x10(0x08)
...
struct FTransformBase {
	FName Node; // 0x00(0x08)
	FTransformBaseConstraint Constraints[0x2]; // 0x08(0x20)
};

// ScriptStruct Engine.TransformBaseConstraint
// Size: 0x10 (Inherited: 0x00)
struct FTransformBaseConstraint {
	TArray<FRigTransformConstraint> TransformConstraints; // 0x00(0x10)
};
...
struct FRootMotionSource {
	...
	FName InstanceName; // 0x18(0x08)
	float StartTime; // 0x20(0x04)
	float CurrentTime; // 0x24(0x04)
	float PreviousTime; // 0x28(0x04)
	float Duration; // 0x2c(0x04)
	FRootMotionSourceStatus Status; // 0x30(0x01)
	FRootMotionSourceSettings Settings; // 0x31(0x01)
	bool bInLocalSpace; // 0x32(0x01)
	FRootMotionMovementParams RootMotionParams; // 0x40(0x40)
	FRootMotionFinishVelocitySettings FinishVelocityParams; // 0x80(0x14)
};
...
struct FRootMotionSource_JumpForce : FRootMotionSource {
	FRotator Rotation; // 0x98(0x0c)
	float Distance; // 0xa4(0x04)
	float Height; // 0xa8(0x04)
	bool bDisableTimeout; // 0xac(0x01)
	UCurveVector* PathOffsetCurve; // 0xb0(0x08)
	UCurveFloat* TimeMappingCurve; // 0xb8(0x08)
};

// ScriptStruct Engine.RootMotionSource_MoveToDynamicForce
// Size: 0xd0 (Inherited: 0xa0)
struct FRootMotionSource_MoveToDynamicForce : FRootMotionSource {
	FVector StartLocation; // 0x98(0x0c)
	FVector InitialTargetLocation; // 0xa4(0x0c)
	FVector TargetLocation; // 0xb0(0x0c)
	bool bRestrictSpeedToExpected; // 0xbc(0x01)
	UCurveVector* PathOffsetCurve; // 0xc0(0x08)
	UCurveFloat* TimeMappingCurve; // 0xc8(0x08)
};
...
struct FRootMotionSource_MoveToForce : FRootMotionSource {
	FVector StartLocation; // 0x98(0x0c)
	FVector TargetLocation; // 0xa4(0x0c)
	bool bRestrictSpeedToExpected; // 0xb0(0x01)
	UCurveVector* PathOffsetCurve; // 0xb8(0x08)
};

// ScriptStruct Engine.RootMotionSource_RadialForce
// Size: 0xe0 (Inherited: 0xa0)
struct FRootMotionSource_RadialForce : FRootMotionSource {
	FVector Location; // 0x98(0x0c)
	AActor* LocationActor; // 0xa8(0x08)
	float Radius; // 0xb0(0x04)
	float Strength; // 0xb4(0x04)
	bool bIsPush; // 0xb8(0x01)
	bool bNoZForce; // 0xb9(0x01)
	UCurveFloat* StrengthDistanceFalloff; // 0xc0(0x08)
	UCurveFloat* StrengthOverTime; // 0xc8(0x08)
	bool bUseFixedWorldDirection; // 0xd0(0x01)
	FRotator FixedWorldDirection; // 0xd4(0x0c)
};

// ScriptStruct Engine.RootMotionSource_ConstantForce
// Size: 0xb0 (Inherited: 0xa0)
struct FRootMotionSource_ConstantForce : FRootMotionSource {
	FVector Force; // 0x98(0x0c)
	UCurveFloat* StrengthOverTime; // 0xa8(0x08)
};
...
struct FCameraExposureSettings {
	...
	UCurveFloat* BiasCurve; // 0x20(0x08)
	UTexture* MeterMask; // 0x28(0x08)
...
struct FLensSettings {
	FLensBloomSettings Bloom; // 0x00(0xb8)
	FLensImperfectionSettings Imperfections; // 0xb8(0x20)
...
struct FLensImperfectionSettings {
	UTexture* DirtMask; // 0x00(0x08)
	float DirtMaskIntensity; // 0x08(0x04)
	FLinearColor DirtMaskTint; // 0x0c(0x10)
};

// ScriptStruct Engine.LensBloomSettings
// Size: 0xb8 (Inherited: 0x00)
struct FLensBloomSettings {
	FGaussianSumBloomSettings GaussianSum; // 0x00(0x84)
	FConvolutionBloomSettings Convolution; // 0x88(0x28)
...
struct FColorGradingSettings {
	FColorGradePerRangeSettings Global; // 0x00(0x50)
	FColorGradePerRangeSettings Shadows; // 0x50(0x50)
	FColorGradePerRangeSettings Midtones; // 0xa0(0x50)
	FColorGradePerRangeSettings Highlights; // 0xf0(0x50)
...
struct FColorGradePerRangeSettings {
	FVector4 Saturation; // 0x00(0x10)
	FVector4 Contrast; // 0x10(0x10)
	FVector4 Gamma; // 0x20(0x10)
	FVector4 Gain; // 0x30(0x10)
	FVector4 Offset; // 0x40(0x10)
};

// ScriptStruct Engine.EngineShowFlagsSetting
// Size: 0x18 (Inherited: 0x00)
struct FEngineShowFlagsSetting {
	FString ShowFlagName; // 0x00(0x10)
...
struct FSingleAnimationPlayData {
	UAnimationAsset* AnimToPlay; // 0x00(0x08)
...
struct FSkeletalMaterial {
	...
	FName MaterialSlotName; // 0x08(0x08)
...
struct FClothingAssetData_Legacy {
	FName AssetName; // 0x00(0x08)
	FString ApexFileName; // 0x08(0x10)
...
struct FSkeletalMeshLODInfo {
	FPerPlatformFloat ScreenSize; // 0x00(0x04)
	float LODHysteresis; // 0x04(0x04)
	TArray<int32_t> LODMaterialMap; // 0x08(0x10)
	FSkeletalMeshBuildSettings BuildSettings; // 0x18(0x14)
	FSkeletalMeshOptimizationSettings ReductionSettings; // 0x2c(0x3c)
	TArray<FBoneReference> BonesToRemove; // 0x68(0x10)
	TArray<FBoneReference> BonesToPrioritize; // 0x78(0x10)
	float WeightOfPrioritization; // 0x88(0x04)
	UAnimSequence* BakePose; // 0x90(0x08)
	UAnimSequence* BakePoseOverride; // 0x98(0x08)
	FString SourceImportFilename; // 0xa0(0x10)
...
struct FSkeletalMeshClothBuildParams {
	TWeakObjectPtr<UClothingAssetBase> TargetAsset; // 0x00(0x08)
	...
	TSoftObjectPtr<UPhysicsAsset> PhysicsAsset; // 0x30(0x28)
};
...
struct FBoneMirrorExport {
	FName BoneName; // 0x00(0x08)
	FName SourceBoneName; // 0x08(0x08)
...
struct FSkeletalMeshLODGroupSettings {
	...
	UAnimSequence* BakePose; // 0x38(0x08)
	FSkeletalMeshOptimizationSettings ReductionSettings; // 0x40(0x3c)
};
...
struct FSkeletalMeshSamplingInfo {
	TArray<FSkeletalMeshSamplingRegion> Regions; // 0x00(0x10)
...
struct FSkeletalMeshSamplingBuiltData {
	TArray<FSkeletalMeshSamplingLODBuiltData> WholeMeshBuiltData; // 0x00(0x10)
...
struct FSkeletalMeshSamplingRegionMaterialFilter {
	FName MaterialName; // 0x00(0x08)
};

// ScriptStruct Engine.VirtualBone
// Size: 0x18 (Inherited: 0x00)
struct FVirtualBone {
	FName SourceBoneName; // 0x00(0x08)
	FName TargetBoneName; // 0x08(0x08)
	FName VirtualBoneName; // 0x10(0x08)
};
...
struct FAnimSlotGroup {
	FName GroupName; // 0x00(0x08)
	TArray<FName> SlotNames; // 0x08(0x10)
};
...
struct FRigConfiguration {
	URig* Rig; // 0x00(0x08)
	TArray<FNameMapping> BoneMappingTable; // 0x08(0x10)
};

// ScriptStruct Engine.NameMapping
// Size: 0x10 (Inherited: 0x00)
struct FNameMapping {
	FName NodeName; // 0x00(0x08)
	FName BoneName; // 0x08(0x08)
};
...
struct FBoneReductionSetting {
	TArray<FName> BonesToRemove; // 0x00(0x10)
};

// ScriptStruct Engine.ReferencePose
// Size: 0x18 (Inherited: 0x00)
struct FReferencePose {
	FName PoseName; // 0x00(0x08)
	TArray<FTransform> ReferencePose; // 0x08(0x10)
};
...
struct FSkeletonToMeshLinkup {
	TArray<int32_t> SkeletonToMeshTable; // 0x00(0x10)
...
struct FSkelMeshComponentLODInfo {
	TArray<bool> HiddenMaterials; // 0x00(0x10)
};
...
struct FSkinWeightProfileInfo {
	FName Name; // 0x00(0x08)
	FPerPlatformBool DefaultProfile; // 0x08(0x01)
	FPerPlatformInt DefaultProfileFromLODIndex; // 0x0c(0x04)
};
...
struct FSoundAttenuationSettings : FBaseAttenuationSettings {
	...
	FRuntimeFloatCurve CustomLowpassAirAbsorptionCurve; // 0xd0(0x88)
	FRuntimeFloatCurve CustomHighpassAirAbsorptionCurve; // 0x158(0x88)
	...
	FRuntimeFloatCurve CustomReverbSendCurve; // 0x238(0x88)
	TArray<FAttenuationSubmixSendSettings> SubmixSendSettings; // 0x2c0(0x10)
	...
	FRuntimeFloatCurve CustomPriorityAttenuationCurve; // 0x2e8(0x88)
	FSoundAttenuationPluginSettings PluginSettings; // 0x370(0x30)
};

// ScriptStruct Engine.SoundAttenuationPluginSettings
// Size: 0x30 (Inherited: 0x00)
struct FSoundAttenuationPluginSettings {
	TArray<USpatializationPluginSourceSettingsBase*> SpatializationPluginSettingsArray; // 0x00(0x10)
...
struct FAttenuationSubmixSendSettings {
	...
	FRuntimeFloatCurve CustomSubmixSendCurve; // 0x20(0x88)
};

// ScriptStruct Engine.PassiveSoundMixModifier
// Size: 0x10 (Inherited: 0x00)
struct FPassiveSoundMixModifier {
	USoundMix* SoundMix; // 0x00(0x08)
...
struct FSoundClassProperties {
	...
	USoundSubmix* DefaultSubmix; // 0x30(0x08)
};
...
struct FSourceEffectChainEntry {
	USoundEffectSourcePreset* Preset; // 0x00(0x08)
...
struct FSoundClassAdjuster {
	USoundClass* SoundClassObject; // 0x00(0x08)
...
struct FSoundSourceBusSendInfo {
	...
	USoundSourceBus* SoundSourceBus; // 0x08(0x08)
...
struct FSoundSubmixSendInfo {
	...
	USoundSubmixBase* SoundSubmix; // 0x08(0x08)
	float SendLevel; // 0x10(0x04)
	float MinSendLevel; // 0x14(0x04)
	float MaxSendLevel; // 0x18(0x04)
	float MinSendDistance; // 0x1c(0x04)
...
struct FSoundWaveSpectralTimeData {
	TArray<FSoundWaveSpectralDataEntry> Data; // 0x00(0x10)
...
struct FSoundWaveEnvelopeDataPerSound {
	...
	USoundWave* SoundWave; // 0x08(0x08)
};

// ScriptStruct Engine.SoundWaveSpectralDataPerSound
// Size: 0x20 (Inherited: 0x00)
struct FSoundWaveSpectralDataPerSound {
	TArray<FSoundWaveSpectralData> SpectralData; // 0x00(0x10)
...
struct FSplineInstanceData : FSceneComponentInstanceData {
	...
	FSplineCurves SplineCurves; // 0xb0(0x68)
	FSplineCurves SplineCurvesPreUCS; // 0x118(0x68)
};

// ScriptStruct Engine.SplineCurves
// Size: 0x68 (Inherited: 0x00)
struct FSplineCurves {
	FInterpCurveVector Position; // 0x00(0x18)
	FInterpCurveQuat Rotation; // 0x18(0x18)
	FInterpCurveVector Scale; // 0x30(0x18)
	FInterpCurveFloat ReparamTable; // 0x48(0x18)
	USplineMetadata* MetaData; // 0x60(0x08)
};
...
struct FSplineMeshInstanceData : FSceneComponentInstanceData {
	FVector StartPos; // 0xa8(0x0c)
	FVector EndPos; // 0xb4(0x0c)
	FVector StartTangent; // 0xc0(0x0c)
	FVector EndTangent; // 0xcc(0x0c)
};

// ScriptStruct Engine.SplineMeshParams
// Size: 0x58 (Inherited: 0x00)
struct FSplineMeshParams {
	FVector StartPos; // 0x00(0x0c)
	FVector StartTangent; // 0x0c(0x0c)
	FVector2D StartScale; // 0x18(0x08)
	float StartRoll; // 0x20(0x04)
	FVector2D StartOffset; // 0x24(0x08)
	FVector EndPos; // 0x2c(0x0c)
	FVector2D EndScale; // 0x38(0x08)
	FVector EndTangent; // 0x40(0x0c)
	float EndRoll; // 0x4c(0x04)
	FVector2D EndOffset; // 0x50(0x08)
};
...
struct FMaterialRemapIndex {
	...
	TArray<int32_t> MaterialRemap; // 0x08(0x10)
};
...
struct FStaticMaterial {
	UMaterialInterface* MaterialInterface; // 0x00(0x08)
	FName MaterialSlotName; // 0x08(0x08)
	FName ImportedMaterialSlotName; // 0x10(0x08)
	FMeshUVChannelInfo UVChannelData; // 0x18(0x14)
};
...
struct FAssetEditorOrbitCameraPosition {
	...
	FVector CamOrbitPoint; // 0x04(0x0c)
	FVector CamOrbitZoom; // 0x10(0x0c)
	FRotator CamOrbitRotation; // 0x1c(0x0c)
};

// ScriptStruct Engine.MeshSectionInfoMap
// Size: 0x50 (Inherited: 0x00)
struct FMeshSectionInfoMap {
	TMap<uint32_t, FMeshSectionInfo> Map; // 0x00(0x50)
};
...
struct FStaticMeshSourceModel {
	FMeshBuildSettings BuildSettings; // 0x00(0x30)
	FMeshReductionSettings ReductionSettings; // 0x30(0x24)
	float LODDistance; // 0x54(0x04)
	FPerPlatformFloat ScreenSize; // 0x58(0x04)
	FString SourceImportFilename; // 0x60(0x10)
};
...
struct FStaticMeshComponentInstanceData : FPrimitiveComponentInstanceData {
	UStaticMesh* StaticMesh; // 0xf0(0x08)
	TArray<FStaticMeshVertexColorLODData> VertexColorLODs; // 0xf8(0x10)
	TArray<FGuid> CachedStaticLighting; // 0x108(0x10)
	TArray<FStreamingTextureBuildInfo> StreamingTextureData; // 0x118(0x10)
};
...
struct FStaticMeshVertexColorLODData {
	TArray<FPaintedVertex> PaintedVertices; // 0x00(0x10)
...
struct FPaintedVertex {
	FVector Position; // 0x00(0x0c)
	FColor Color; // 0x0c(0x04)
	FVector4 Normal; // 0x10(0x10)
};
...
struct FStaticParameterSet {
	TArray<FStaticSwitchParameter> StaticSwitchParameters; // 0x00(0x10)
	...
	TArray<FStaticMaterialLayersParameter> MaterialLayersParameters; // 0x30(0x10)
};
...
struct FStaticMaterialLayersParameter : FStaticParameterBase {
	FMaterialLayersFunctions Value; // 0x28(0x40)
};
...
struct FEquirectProps {
	FBox2D LeftUVRect; // 0x00(0x14)
	FBox2D RightUVRect; // 0x14(0x14)
	FVector2D LeftScale; // 0x28(0x08)
	FVector2D RightScale; // 0x30(0x08)
	FVector2D LeftBias; // 0x38(0x08)
	FVector2D RightBias; // 0x40(0x08)
};
...
struct FSubsurfaceProfileStruct {
	FLinearColor SurfaceAlbedo; // 0x00(0x10)
	...
	FLinearColor SubsurfaceColor; // 0x30(0x10)
	FLinearColor FalloffColor; // 0x40(0x10)
	FLinearColor BoundaryColorBleed; // 0x50(0x10)
	...
	FLinearColor TransmissionTintColor; // 0x7c(0x10)
};
...
struct FTextureLODGroup {
	...
	FName MinMagFilter; // 0x40(0x08)
	FName MipFilter; // 0x48(0x08)
...
struct FStreamingRenderAssetPrimitiveInfo {
	UStreamableRenderAsset* RenderAsset; // 0x00(0x08)
	FBoxSphereBounds Bounds; // 0x08(0x1c)
...
struct FTimeline {
	...
	FDelegate TimelinePostUpdateFunc; // 0x50(0x10)
	FDelegate TimelineFinishedFunc; // 0x60(0x10)
	TWeakObjectPtr<UObject> PropertySetObject; // 0x70(0x08)
	FName DirectionPropertyName; // 0x78(0x08)
};

// ScriptStruct Engine.TimelineLinearColorTrack
// Size: 0x40 (Inherited: 0x00)
struct FTimelineLinearColorTrack {
	UCurveLinearColor* LinearColorCurve; // 0x00(0x08)
	FDelegate InterpFunc; // 0x08(0x10)
	FName TrackName; // 0x18(0x08)
	FName LinearColorPropertyName; // 0x20(0x08)
};

// ScriptStruct Engine.TimelineFloatTrack
// Size: 0x40 (Inherited: 0x00)
struct FTimelineFloatTrack {
	UCurveFloat* FloatCurve; // 0x00(0x08)
	FDelegate InterpFunc; // 0x08(0x10)
	FName TrackName; // 0x18(0x08)
	FName FloatPropertyName; // 0x20(0x08)
};

// ScriptStruct Engine.TimelineVectorTrack
// Size: 0x40 (Inherited: 0x00)
struct FTimelineVectorTrack {
	UCurveVector* VectorCurve; // 0x00(0x08)
	FDelegate InterpFunc; // 0x08(0x10)
	FName TrackName; // 0x18(0x08)
	FName VectorPropertyName; // 0x20(0x08)
};
...
struct FTimelineEventEntry {
	float Time; // 0x00(0x04)
	FDelegate EventFunc; // 0x04(0x10)
};

// ScriptStruct Engine.TTTrackBase
// Size: 0x18 (Inherited: 0x00)
struct FTTTrackBase {
	FName TrackName; // 0x08(0x08)
...
struct FTTEventTrack : FTTTrackBase {
	...
	UCurveFloat* CurveKeys; // 0x20(0x08)
};
...
struct FTimeStretchCurve {
	...
	TArray<FTimeStretchCurveMarker> Markers; // 0x08(0x10)
...
struct FTouchInputControl {
	UTexture2D* Image1; // 0x00(0x08)
	UTexture2D* Image2; // 0x08(0x08)
	FVector2D Center; // 0x10(0x08)
	FVector2D VisualSize; // 0x18(0x08)
	FVector2D ThumbSize; // 0x20(0x08)
	FVector2D InteractionSize; // 0x28(0x08)
	FVector2D InputScale; // 0x30(0x08)
	FKey MainInputKey; // 0x38(0x18)
	FKey AltInputKey; // 0x50(0x18)
};

// ScriptStruct Engine.HardwareCursorReference
// Size: 0x10 (Inherited: 0x00)
struct FHardwareCursorReference {
	FName CursorPath; // 0x00(0x08)
	FVector2D HotSpot; // 0x08(0x08)
};
...
struct FVirtualTextureSpacePoolConfig {
	...
	TArray<enum class EPixelFormat> Formats; // 0x08(0x10)
...
struct FVoiceSettings {
	USceneComponent* ComponentToAttachTo; // 0x00(0x08)
	USoundAttenuation* AttenuationSettings; // 0x08(0x08)
	USoundEffectSourcePresetChain* SourceEffectChain; // 0x10(0x08)
};

// ScriptStruct Engine.StreamingLevelsToConsider
// Size: 0x28 (Inherited: 0x00)
struct FStreamingLevelsToConsider {
	TArray<FLevelStreamingWrapper> StreamingLevels; // 0x00(0x10)
};

// ScriptStruct Engine.LevelStreamingWrapper
// Size: 0x08 (Inherited: 0x00)
struct FLevelStreamingWrapper {
	ULevelStreaming* StreamingLevel; // 0x00(0x08)
};

// ScriptStruct Engine.LevelCollection
// Size: 0x78 (Inherited: 0x00)
struct FLevelCollection {
	AGameStateBase* GameState; // 0x08(0x08)
	UNetDriver* NetDriver; // 0x10(0x08)
	UDemoNetDriver* DemoNetDriver; // 0x18(0x08)
	ULevel* PersistentLevel; // 0x20(0x08)
...
struct FLevelViewportInfo {
	FVector CamPosition; // 0x00(0x0c)
	FRotator CamRotation; // 0x0c(0x0c)
...
struct FWorldPSCPool {
	TMap<UParticleSystem*, FPSCPool> WorldParticleSystemPools; // 0x00(0x50)
};

// ScriptStruct Engine.PSCPool
// Size: 0x38 (Inherited: 0x00)
struct FPSCPool {
	TArray<FPSCPoolElem> FreeElements; // 0x00(0x10)
	TArray<UParticleSystemComponent*> InUseComponents_Auto; // 0x10(0x10)
	TArray<UParticleSystemComponent*> InUseComponents_Manual; // 0x20(0x10)
};

// ScriptStruct Engine.PSCPoolElem
// Size: 0x10 (Inherited: 0x00)
struct FPSCPoolElem {
	UParticleSystemComponent* PSC; // 0x00(0x08)
};
...
struct FBroadphaseSettings {
	...
	FBox MBPBounds; // 0x04(0x1c)
	FBox MBPOuterBounds; // 0x20(0x1c)
...
struct FHierarchicalSimplification {
	...
	FMeshProxySettings ProxySetting; // 0x0c(0xa8)
	FMeshMergingSettings MergeSetting; // 0xb4(0xa0)
...
// Size: 0x30 (Inherited: 0x00)
struct FNetViewer {
	UNetConnection* Connection; // 0x00(0x08)
	AActor* InViewer; // 0x08(0x08)
	AActor* ViewTarget; // 0x10(0x08)
	FVector ViewLocation; // 0x18(0x0c)
	FVector ViewDir; // 0x24(0x0c)
};
...
struct FLightmassWorldInfoSettings {
	...
	FColor EnvironmentColor; // 0x14(0x04)
