...
struct UMotionControllerComponent : UPrimitiveComponent {
	...
	FName DisplayModelSource; // 0x420(0x08)
	UStaticMesh* CustomDisplayMesh; // 0x428(0x08)
	TArray<UMaterialInterface*> DisplayMeshMaterialOverrides; // 0x430(0x10)
	UPrimitiveComponent* DisplayComponent; // 0x4a0(0x08)
