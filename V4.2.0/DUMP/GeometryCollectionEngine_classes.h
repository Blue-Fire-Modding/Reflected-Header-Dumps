...
struct UGeometryCollectionComponent : UMeshComponent {
	AChaosSolverActor* ChaosSolverActor; // 0x438(0x08)
	UGeometryCollection* RestCollection; // 0x520(0x08)
	TArray<AFieldSystemActor*> InitializationFields; // 0x528(0x10)
	...
	TArray<float> DamageThreshold; // 0x550(0x10)
	...
	UChaosPhysicalMaterial* PhysicalMaterial; // 0x578(0x08)
	enum class EInitialVelocityTypeEnum InitialVelocityType; // 0x580(0x01)
	FVector InitialLinearVelocity; // 0x584(0x0c)
	FVector InitialAngularVelocity; // 0x590(0x0c)
	FGeomComponentCacheParameters CacheParameters; // 0x5a0(0x50)
	FMulticastInlineDelegate NotifyGeometryCollectionPhysicsStateChange; // 0x5f0(0x10)
	FMulticastInlineDelegate NotifyGeometryCollectionPhysicsLoadingStateChange; // 0x600(0x10)
	FMulticastInlineDelegate OnChaosBreakEvent; // 0x628(0x10)
	float DesiredCacheTime; // 0x638(0x04)
	bool CachePlayback; // 0x63c(0x01)
	FMulticastInlineDelegate OnChaosPhysicsCollision; // 0x640(0x10)
	bool bNotifyBreaks; // 0x650(0x01)
	bool bNotifyCollisions; // 0x651(0x01)
	UBodySetup* DummyBodySetup; // 0x850(0x08)
