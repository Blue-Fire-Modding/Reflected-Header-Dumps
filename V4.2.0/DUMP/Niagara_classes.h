...
struct UNiagaraComponent : UFXSystemComponent {
	UNiagaraSystem* Asset; // 0x408(0x08)
	enum class ENiagaraTickBehavior TickBehavior; // 0x410(0x01)
	FNiagaraUserRedirectionParameterStore OverrideParameters; // 0x418(0x108)
	...
	FMulticastInlineDelegate OnSystemFinished; // 0x558(0x10)
	TWeakObjectPtr<USceneComponent> AutoAttachParent; // 0x568(0x08)
	FName AutoAttachSocketName; // 0x570(0x08)
