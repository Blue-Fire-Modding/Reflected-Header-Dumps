...
struct UMRMeshComponent : UPrimitiveComponent {
	UMaterialInterface* Material; // 0x410(0x08)
	...
	UBodySetup* CachedBodySetup; // 0x420(0x08)
	TArray<UBodySetup*> BodySetups; // 0x428(0x10)
	UMaterialInterface* WireframeMaterial; // 0x438(0x08)
