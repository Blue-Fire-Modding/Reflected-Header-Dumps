...
struct FAkAdvancedInitializationSettings {
	...
	FAkAdvancedSpatialAudioSettings SpatialAudioSettings; // 0x2c(0x08)
};
...
struct FAkExternalSourceInfo {
	FString ExternalSrcName; // 0x00(0x10)
	enum class AkCodecId CodecID; // 0x10(0x01)
	FString Filename; // 0x18(0x10)
	UAkExternalMediaAsset* ExternalSourceAsset; // 0x28(0x08)
...
struct FAkGeometrySurfaceOverride {
	UAkAcousticTexture* AcousticTexture; // 0x00(0x08)
...
struct FAkGeometryData {
	...
	TArray<FAkAcousticSurface> Surfaces; // 0x10(0x10)
	TArray<FAkTriangle> Triangles; // 0x20(0x10)
	TArray<UPhysicalMaterial*> ToOverrideAcousticTexture; // 0x30(0x10)
	TArray<UPhysicalMaterial*> ToOverrideOcclusion; // 0x40(0x10)
};
...
struct FAkCommonInitializationSettings {
	...
	FAkMainOutputSettings MainOutputSettings; // 0x10(0x28)
	float StreamingLookAheadRatio; // 0x38(0x04)
	uint16_t NumberOfRefillsInVoice; // 0x3c(0x02)
	FAkSpatialAudioSettings SpatialAudioSettings; // 0x40(0x20)
};
...
struct FAkMainOutputSettings {
	FString AudioDeviceShareset; // 0x00(0x10)
...
struct FAkBoolPropertyToControl {
	FString ItemProperty; // 0x00(0x10)
};
...
struct FAkGeometrySurfacePropertiesToMap {
	TSoftObjectPtr<UAkAcousticTexture> AcousticTexture; // 0x00(0x28)
...
struct FAkWwiseItemToControl {
	FAkWwiseObjectDetails ItemPicked; // 0x00(0x30)
	FString ItemPath; // 0x30(0x10)
};
...
struct FAkWwiseObjectDetails {
	...
	FString ItemPath; // 0x10(0x10)
	FString ItemId; // 0x20(0x10)
};

// ScriptStruct AkAudio.AkPoly
// Size: 0x10 (Inherited: 0x00)
struct FAkPoly {
	UAkAcousticTexture* Texture; // 0x00(0x08)
...
struct FAkAudioEventTrackKey {
	...
	UAkAudioEvent* AkAudioEvent; // 0x08(0x08)
...
struct FMovieSceneFloatChannelSerializationHelper {
	...
	TArray<int32_t> Times; // 0x08(0x10)
	TArray<FMovieSceneFloatValueSerializationHelper> Values; // 0x18(0x10)
...
struct FMovieSceneFloatValueSerializationHelper {
	...
	FMovieSceneTangentDataSerializationHelper Tangent; // 0x08(0x14)
};
