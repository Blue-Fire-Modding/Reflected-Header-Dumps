...
struct UAkAudioBank : UAkAssetBase {
	...
	UAkAssetPlatformData* CurrentLocalizedPlatformAssetData; // 0xb0(0x08)
};
...
struct UAkAudioEvent : UAkAssetBase {
	...
	UAkAssetPlatformData* CurrentLocalizedPlatformData; // 0xb0(0x08)
...
struct UAkSettingsPerUser : UObject {
	...
	FString WaapiIPAddress; // 0x48(0x10)
