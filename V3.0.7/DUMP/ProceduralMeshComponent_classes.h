...
struct UProceduralMeshComponent : UMeshComponent {
	...
	UBodySetup* ProcMeshBodySetup; // 0x440(0x08)
	TArray<FProcMeshSection> ProcMeshSections; // 0x448(0x10)
	TArray<FKConvexElem> CollisionConvexElems; // 0x458(0x10)
	FBoxSphereBounds LocalBounds; // 0x468(0x1c)
	TArray<UBodySetup*> AsyncBodySetupQueue; // 0x488(0x10)
