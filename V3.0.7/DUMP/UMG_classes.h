...
struct UWidgetComponent : UMeshComponent {
	...
	UUserWidget* WidgetClass; // 0x438(0x08)
	FIntPoint DrawSize; // 0x440(0x08)
	bool bManuallyRedraw; // 0x448(0x01)
	bool bRedrawRequested; // 0x449(0x01)
	float RedrawTime; // 0x44c(0x04)
	FIntPoint CurrentDrawSize; // 0x458(0x08)
	bool bDrawAtDesiredSize; // 0x460(0x01)
	FVector2D Pivot; // 0x464(0x08)
	...
	ULocalPlayer* OwnerPlayer; // 0x470(0x08)
	FLinearColor BackgroundColor; // 0x478(0x10)
	FLinearColor TintColorAndOpacity; // 0x488(0x10)
	...
	UUserWidget* Widget; // 0x4a0(0x08)
	UBodySetup* BodySetup; // 0x4c8(0x08)
	UMaterialInterface* TranslucentMaterial; // 0x4d0(0x08)
	UMaterialInterface* TranslucentMaterial_OneSided; // 0x4d8(0x08)
	UMaterialInterface* OpaqueMaterial; // 0x4e0(0x08)
	UMaterialInterface* OpaqueMaterial_OneSided; // 0x4e8(0x08)
	UMaterialInterface* MaskedMaterial; // 0x4f0(0x08)
	UMaterialInterface* MaskedMaterial_OneSided; // 0x4f8(0x08)
	UTextureRenderTarget2D* RenderTarget; // 0x500(0x08)
	UMaterialInstanceDynamic* MaterialInstance; // 0x508(0x08)
	bool bAddedToScreen; // 0x510(0x01)
	bool bEditTimeUsable; // 0x511(0x01)
	FName SharedLayerName; // 0x514(0x08)
