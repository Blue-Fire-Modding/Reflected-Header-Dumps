// WidgetBlueprintGeneratedClass ControlsUI_Switch.ControlsUI_Switch_C
// Size: 0x260 (Inherited: 0x238)
struct UControlsUI_Switch_C : UControlsUI_Master_C {
	...
	UImage* Image_96; // 0x258(0x08)

	void PreConstruct(bool IsDesignTime);
	void Construct();
	void Refresh();
	void ExecuteUbergraph_ControlsUI_Switch(int32_t EntryPoint);
};
