// WidgetBlueprintGeneratedClass ControlsUI_Xbox.ControlsUI_Xbox_C
// Size: 0x268 (Inherited: 0x238)
struct UControlsUI_Xbox_C : UControlsUI_Master_C {
	...
	void Construct();
	void Refresh();
	void ExecuteUbergraph_ControlsUI_Xbox(int32_t EntryPoint);
};
