...
struct ALandscapeProxy : AActor {
	...
	FBodyInstance BodyInstance; // 0x3c8(0x130)
	...
	TMap<UTexture2D*, ULandscapeWeightmapUsage*> WeightmapUsageMap; // 0x510(0x50)
...
struct ULandscapeComponent : UPrimitiveComponent {
	...
	UMaterialInterface* OverrideMaterial; // 0x420(0x08)
	UMaterialInterface* OverrideHoleMaterial; // 0x428(0x08)
	TArray<FLandscapeComponentMaterialOverride> OverrideMaterials; // 0x430(0x10)
	TArray<UMaterialInstanceConstant*> MaterialInstances; // 0x440(0x10)
	TArray<UMaterialInstanceDynamic*> MaterialInstancesDynamic; // 0x450(0x10)
	TArray<int8_t> LODIndexToMaterialIndex; // 0x460(0x10)
	TArray<int8_t> MaterialIndexToDisabledTessellationMaterial; // 0x470(0x10)
	UTexture2D* XYOffsetmapTexture; // 0x480(0x08)
	FVector4 WeightmapScaleBias; // 0x490(0x10)
	float WeightmapSubsectionOffset; // 0x4a0(0x04)
	FVector4 HeightmapScaleBias; // 0x4b0(0x10)
	FBox CachedLocalBox; // 0x4c0(0x1c)
	LazyObjectProperty CollisionComponent; // 0x4dc(0x1c)
	UTexture2D* HeightmapTexture; // 0x4f8(0x08)
	TArray<FWeightmapLayerAllocationInfo> WeightmapLayerAllocations; // 0x500(0x10)
	TArray<UTexture2D*> WeightmapTextures; // 0x510(0x10)
	FGuid MapBuildDataId; // 0x520(0x10)
	TArray<FGuid> IrrelevantLights; // 0x530(0x10)
	...
	FGuid StateId; // 0x55c(0x10)
	FGuid BakedTextureMaterialGuid; // 0x56c(0x10)
	UTexture2D* GIBakedBaseColorTexture; // 0x580(0x08)
	char MobileBlendableLayerMask; // 0x588(0x01)
	UMaterialInterface* MobileMaterialInterface; // 0x590(0x08)
	TArray<UMaterialInterface*> MobileMaterialInterfaces; // 0x598(0x10)
	TArray<UTexture2D*> MobileWeightmapTextures; // 0x5a8(0x10)
...
struct ULandscapeHeightfieldCollisionComponent : UPrimitiveComponent {
	TArray<ULandscapeLayerInfoObject*> ComponentLayerInfos; // 0x408(0x10)
	...
	TArray<char> CollisionQuadFlags; // 0x430(0x10)
	FGuid HeightfieldGuid; // 0x440(0x10)
	FBox CachedLocalBox; // 0x450(0x1c)
	LazyObjectProperty RenderComponent; // 0x46c(0x1c)
	TArray<UPhysicalMaterial*> CookedPhysicalMaterials; // 0x498(0x10)
...
struct ULandscapeMeshProxyComponent : UStaticMeshComponent {
	FGuid LandscapeGuid; // 0x498(0x10)
	TArray<FIntPoint> ProxyComponentBases; // 0x4a8(0x10)
...
struct ULandscapeSplinesComponent : UPrimitiveComponent {
	TArray<ULandscapeSplineControlPoint*> ControlPoints; // 0x408(0x10)
	TArray<ULandscapeSplineSegment*> Segments; // 0x418(0x10)
	TArray<UMeshComponent*> CookedForeignMeshComponents; // 0x428(0x10)
