...
struct FAnchors {
	FVector2D Minimum; // 0x00(0x08)
	FVector2D Maximum; // 0x08(0x08)
};
...
struct FCustomizedToolMenu {
	...
	TMap<FName, FCustomizedToolMenuEntry> Entries; // 0x08(0x50)
	TMap<FName, FCustomizedToolMenuSection> Sections; // 0x58(0x50)
	TMap<FName, FCustomizedToolMenuNameArray> EntryOrder; // 0xa8(0x50)
	TArray<FName> SectionOrder; // 0xf8(0x10)
};

// ScriptStruct Slate.CustomizedToolMenuNameArray
// Size: 0x10 (Inherited: 0x00)
struct FCustomizedToolMenuNameArray {
	TArray<FName> Names; // 0x00(0x10)
};
