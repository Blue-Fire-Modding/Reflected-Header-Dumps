...
FAKWaapiJsonObject UAkWaapiCalls::SubscribeToWaapi(const FAkWaapiUri& WaapiUri, const FAKWaapiJsonObject& WaapiOptions, const FAkWaapiCallsCallback& Callback, FAkWaapiSubscriptionId& SubscriptionId, bool& SubscriptionDone) {
    return FAKWaapiJsonObject{};
}
...
bool UAkWaapiCalls::RegisterWaapiProjectLoadedCallback(const FAkWaapiCallsCallback& Callback) {
    return false;
}

bool UAkWaapiCalls::RegisterWaapiConnectionLostCallback(const FAkWaapiCallsCallback& Callback) {
    return false;
}
